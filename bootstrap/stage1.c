...
void qoz_emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    {
        qoz_Strbuf _qoz_sb_4691_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4691_21); qoz_strings_sb_append(&_qoz_sb_4691_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4691_21, e->match_counter); _qoz_bv_404 = qoz_strings_sb_finish(&_qoz_sb_4691_21);
    }
    qoz_string scrut_tmp = _qoz_bv_404; qoz_string _qoz_bv_405;
    {
        qoz_Strbuf _qoz_sb_4602_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4602_21); qoz_strings_sb_append(&_qoz_sb_4602_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4602_21, e->match_counter); _qoz_bv_405 = qoz_strings_sb_finish(&_qoz_sb_4602_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_4601_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4601_13); qoz_strings_sb_append(&_qoz_sb_4601_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4601_13, enum_name); qoz_strings_sb_append(&_qoz_sb_4601_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4601_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4601_13, QOZ_STR_LIT(" = ")); _qoz_bv_406 = qoz_strings_sb_finish(&_qoz_sb_4601_13);
    }
...
void qoz_emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    {
        qoz_Strbuf _qoz_sb_4639_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4639_21); qoz_strings_sb_append(&_qoz_sb_4639_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4639_21, e->match_counter); _qoz_bv_409 = qoz_strings_sb_finish(&_qoz_sb_4639_21);
    }
    qoz_string scrut_tmp = _qoz_bv_409; qoz_string _qoz_bv_400;
    {
        qoz_Strbuf _qoz_sb_4630_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4630_21); qoz_strings_sb_append(&_qoz_sb_4630_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4630_21, e->match_counter); _qoz_bv_400 = qoz_strings_sb_finish(&_qoz_sb_4630_21);
    }
    qoz_string res_tmp = _qoz_bv_400; qoz_string _qoz_bv_401;
    {
        qoz_Strbuf _qoz_sb_4631_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4631_21); qoz_strings_sb_append(&_qoz_sb_4631_21, QOZ_STR_LIT("_qoz_mm_")); qoz_strings_sb_append_i64(&_qoz_sb_4631_21, e->match_counter); _qoz_bv_401 = qoz_strings_sb_finish(&_qoz_sb_4631_21);
    }
...
void qoz_emit_emit_arm_in_chain_with_te(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_TypeExpr* scrut_te, qoz_string res_tmp, qoz_string mflag, qoz_MatchArm arm, bool is_void) {
    ...
    {
        qoz_Strbuf _qoz_sb_4778_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4778_25); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4778_25, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4778_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4778_25, name); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT(") { ")); _qoz_bv_416 = qoz_strings_sb_finish(&_qoz_sb_4778_25);
    }
    qoz_emit_push(e, _qoz_bv_416);  break; } default: { {
        qoz_string _qoz_bv_417;
    {
        qoz_Strbuf _qoz_sb_4783_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4783_25); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT(") { qoz_")); qoz_strings_sb_append(&_qoz_sb_4783_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4783_25, name); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4783_25, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4783_25, name); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT("; ")); _qoz_bv_417 = qoz_strings_sb_finish(&_qoz_sb_4783_25);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_4798_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4798_24); qoz_strings_sb_append(&_qoz_sb_4798_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4798_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4798_24, QOZ_STR_LIT(" == false) { ")); _qoz_bv_411 = qoz_strings_sb_finish(&_qoz_sb_4798_24);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_4791_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4791_17); qoz_strings_sb_append(&_qoz_sb_4791_17, QOZ_STR_LIT(" && qoz_string_eq(")); qoz_strings_sb_append(&_qoz_sb_4791_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4791_17, QOZ_STR_LIT(", QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4791_17, text); qoz_strings_sb_append(&_qoz_sb_4791_17, QOZ_STR_LIT("))) { ")); _qoz_bv_412 = qoz_strings_sb_finish(&_qoz_sb_4791_17);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_4709_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4709_21); qoz_strings_sb_append(&_qoz_sb_4709_21, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4709_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4709_21, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4709_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4709_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4709_21, vname); _qoz_bv_413 = qoz_strings_sb_finish(&_qoz_sb_4709_21);
    }
    qoz_emit_push(e, _qoz_bv_413); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_string is = qoz_emit_int_to_string(i); qoz_Pattern* _qoz_ms_3 = sp; switch (_qoz_ms_3->tag) { case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_3->payload.PatLitInt.f1; {
        qoz_string tn = qoz_emit_strip_numeric_underscores(text); qoz_string _qoz_bv_424;
    {
        qoz_Strbuf _qoz_sb_4722_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4722_29); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4722_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4722_29, vname); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4722_29, is); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT(" == ")); qoz_strings_sb_append(&_qoz_sb_4722_29, tn); _qoz_bv_424 = qoz_strings_sb_finish(&_qoz_sb_4722_29);
    }
    qoz_emit_push(e, _qoz_bv_424); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_3->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_425;
    {
        qoz_Strbuf _qoz_sb_4725_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4725_36); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4725_36, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4725_36, vname); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4725_36, is); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT(" == true")); _qoz_bv_425 = qoz_strings_sb_finish(&_qoz_sb_4725_36);
    }
    qoz_emit_push(e, _qoz_bv_425); }  else { qoz_string _qoz_bv_426;
    {
        qoz_Strbuf _qoz_sb_4726_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4726_36); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4726_36, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4726_36, vname); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4726_36, is); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT(" == false")); _qoz_bv_426 = qoz_strings_sb_finish(&_qoz_sb_4726_36);
    }
    qoz_emit_push(e, _qoz_bv_426); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_3->payload.PatLitString.f1; qoz_string _qoz_bv_427;
    {
        qoz_Strbuf _qoz_sb_4729_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4729_29); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT(" && qoz_string_eq(")); qoz_strings_sb_append(&_qoz_sb_4729_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4729_29, vname); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4729_29, is); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT(", QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4729_29, text); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT("))")); _qoz_bv_427 = qoz_strings_sb_finish(&_qoz_sb_4729_29);
    }
    qoz_emit_push(e, _qoz_bv_427);  break; } default: { NULL;  break; } } 0; i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(") { ")); int64_t j = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_4 = sp; switch (_qoz_ms_4->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_4->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, j); qoz_string js = qoz_emit_int_to_string(j); qoz_string _qoz_bv_428;
    {
        qoz_Strbuf _qoz_sb_4842_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4842_29); qoz_strings_sb_append(&_qoz_sb_4842_29, pc); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4842_29, bname); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4842_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4842_29, vname); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4842_29, js); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT("; ")); _qoz_bv_428 = qoz_strings_sb_finish(&_qoz_sb_4842_29);
    }
    qoz_emit_push(e, _qoz_bv_428); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, j)); 
    }
...
void qoz_emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    ...
    {
        qoz_Strbuf _qoz_sb_4820_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4820_21); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("default: { qoz_")); qoz_strings_sb_append(&_qoz_sb_4820_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4820_21, name); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4820_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4820_21, name); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("; ")); _qoz_bv_420 = qoz_strings_sb_finish(&_qoz_sb_4820_21);
    }
    qoz_emit_push(e, _qoz_bv_420); qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Vec__qoz_string segs = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&segs, enum_name); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, qoz_make_TypeExpr_TENamed(sp, segs, qoz_vec_make__qoz_TypeExpr())); if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_1->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_421;
    {
        qoz_Strbuf _qoz_sb_4941_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4941_21); qoz_strings_sb_append(&_qoz_sb_4941_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4941_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4941_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4941_21, vname); qoz_strings_sb_append(&_qoz_sb_4941_21, QOZ_STR_LIT(": { ")); _qoz_bv_421 = qoz_strings_sb_finish(&_qoz_sb_4941_21);
    }
    qoz_emit_push(e, _qoz_bv_421); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_3 = sp; switch (_qoz_ms_3->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_3->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_422;
    {
        qoz_Strbuf _qoz_sb_4958_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4958_29); qoz_strings_sb_append(&_qoz_sb_4958_29, pc); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4958_29, bname); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4958_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4958_29, vname); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4958_29, is); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT("; ")); _qoz_bv_422 = qoz_strings_sb_finish(&_qoz_sb_4958_29);
    }
    qoz_emit_push(e, _qoz_bv_422); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string qoz_emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_string _qoz_bv_423;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, bare_enum)) { return qoz_emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_423 = bare_enum;
    }
    _qoz_mv_1 = (_qoz_bv_423);  break; } default: { _qoz_mv_1 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_1->payload.TyInt.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TENamed(sp, qoz_ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_1->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_430;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_430 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_1 = (_qoz_bv_430);  break; } case qoz_Ty_TyBool: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEPtr(sp, qoz_ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyAdt.f1; _qoz_mv_1 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; _qoz_mv_1 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_1->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_431;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, qoz_ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_431 = qoz_make_TypeExpr_TEFn(sp, pte, qoz_ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_1 = (_qoz_bv_431);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_1->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_432;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, qoz_ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_432 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_1 = (_qoz_bv_432);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_1->payload.TyVar.f1; _qoz_mv_1 = (qoz_ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_ty_ty_show(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo i = _qoz_ms_1->payload.TyInt.f0; qoz_string _qoz_bv_433;
    {
        qoz_string prefix = ((i.is_signed) ? QOZ_STR_LIT("i") : QOZ_STR_LIT("u")); qoz_string w = ((i.width == 8) ? QOZ_STR_LIT("8") : ((i.width == 16) ? QOZ_STR_LIT("16") : ((i.width == 32) ? QOZ_STR_LIT("32") : QOZ_STR_LIT("64")))); _qoz_bv_433 = qoz_strings_cat(prefix, w);
    }
    _qoz_mv_1 = (_qoz_bv_433);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo f = _qoz_ms_1->payload.TyFloat.f0; _qoz_mv_1 = (((f.width == 32) ? QOZ_STR_LIT("f32") : QOZ_STR_LIT("f64")));  break; } case qoz_Ty_TyBool: { _qoz_mv_1 = (QOZ_STR_LIT("bool"));  break; } case qoz_Ty_TyChar: { _qoz_mv_1 = (QOZ_STR_LIT("char"));  break; } case qoz_Ty_TyString: { _qoz_mv_1 = (QOZ_STR_LIT("string"));  break; } case qoz_Ty_TyCstring: { _qoz_mv_1 = (QOZ_STR_LIT("cstring"));  break; } case qoz_Ty_TyUnit: { _qoz_mv_1 = (QOZ_STR_LIT("unit"));  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (QOZ_STR_LIT("nil"));  break; } case qoz_Ty_TyError: { _qoz_mv_1 = (QOZ_STR_LIT("<error>"));  break; } case qoz_Ty_TyVar: { qoz_string n = _qoz_ms_1->payload.TyVar.f1; _qoz_mv_1 = (n);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_strings_cat(QOZ_STR_LIT("*"), qoz_ty_ty_show(inner)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyAdt.f1; qoz_string _qoz_bv_444;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_strings_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_444 = qoz_strings_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_1 = (_qoz_bv_444);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; qoz_string _qoz_bv_445;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_445);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty params = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_1->payload.TyFn.f1; qoz_string _qoz_bv_446;
    {
        qoz_string out = QOZ_STR_LIT("fn("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(p)); i = i + 1; } }out = qoz_strings_cat(out, QOZ_STR_LIT(") -> ")); _qoz_bv_446 = qoz_strings_cat(out, qoz_ty_ty_show(ret));
    }
    _qoz_mv_1 = (_qoz_bv_446);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_1->payload.TyTuple.f0; qoz_string _qoz_bv_447;
    {
        qoz_string out = QOZ_STR_LIT("("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* e = __col.data[__i]; (void)e; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(e)); i = i + 1; } }_qoz_bv_447 = qoz_strings_cat(out, QOZ_STR_LIT(")"));
    }
    _qoz_mv_1 = (_qoz_bv_447);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_ty_arg_passes_to_param(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_1 = arg; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyError: { _qoz_mv_1 = (true);  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (qoz_ty_arg_is_nil_accepted_by(param));  break; } case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_1->payload.TyInt.f0; bool _qoz_bv_448;
    {
        if (ai.untyped && qoz_ty_untyped_int_fits(param)) { return true;} qoz_Ty* _qoz_ms_2 = param; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_2->payload.TyInt.f0; _qoz_mv_2 = (qoz_ty_int_widens_to(pi, ai));  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_bv_448 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_448);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_1->payload.TyFloat.f0; bool _qoz_bv_449;
    {
        if (af.untyped && qoz_ty_untyped_float_fits(param)) { return true;} qoz_Ty* _qoz_ms_3 = param; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_3->payload.TyFloat.f0; _qoz_mv_3 = (pf.width >= af.width);  break; } default: { _qoz_mv_3 = (false);  break; } } _qoz_bv_449 = _qoz_mv_3;
    }
    _qoz_mv_1 = (_qoz_bv_449);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_ty_same_constructor_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_1 = param; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_1->payload.TyAdt.f1; qoz_Ty* _qoz_ms_2 = arg; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_2->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_2->payload.TyAdt.f1; bool _qoz_bv_440;
    {
        if (!qoz_strings_eq_raw(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_440 = true;
    }
    _qoz_mv_2 = (_qoz_bv_440);  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Ty_TyRecord: { qoz_string pn = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_1->payload.TyRecord.f1; qoz_Ty* _qoz_ms_3 = arg; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_3->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_3->payload.TyRecord.f1; bool _qoz_bv_441;
    {
