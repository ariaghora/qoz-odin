...
qoz_Ty* qoz_check_synth_inner(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&e);
    qoz_Expr* _qoz_ms_1 = e; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EInt: { _qoz_mv_1 = (qoz_ty_ty_int_untyped());  break; } case qoz_Expr_EFloat: { _qoz_mv_1 = (qoz_ty_ty_float_untyped());  break; } case qoz_Expr_EString: { _qoz_mv_1 = (qoz_ty_ty_string_());  break; } case qoz_Expr_EChar: { _qoz_mv_1 = (qoz_ty_ty_char_());  break; } case qoz_Expr_EBool: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_Expr_ENil: { _qoz_mv_1 = (qoz_ty_ty_nil_());  break; } case qoz_Expr_EIdent: { qoz_Span span = _qoz_ms_1->payload.EIdent.f0; qoz_string name = _qoz_ms_1->payload.EIdent.f1; _qoz_mv_1 = (qoz_check_synth_ident(tc, env, span, name));  break; } case qoz_Expr_EPath: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; _qoz_mv_1 = (qoz_check_synth_unary(tc, env, op, rhs));  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_1->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_1->payload.EBinary.f3; _qoz_mv_1 = (qoz_check_synth_binary(tc, env, op, l, r));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_1->payload.EAssign.f0; qoz_Expr* l = _qoz_ms_1->payload.EAssign.f2; qoz_Expr* v = _qoz_ms_1->payload.EAssign.f3; _qoz_mv_1 = (qoz_check_check_assign(tc, env, sp, l, v));  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_1->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_1->payload.ECall.f3; _qoz_mv_1 = (qoz_check_synth_call_full(tc, env, sp, callee, ta, args));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; _qoz_mv_1 = (qoz_check_synth_field(tc, env, sp, base, name));  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_1->payload.EIndex.f2; _qoz_mv_1 = (qoz_check_synth_index(tc, env, base, idx));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* te = _qoz_ms_1->payload.ECast.f2; _qoz_mv_1 = (qoz_check_resolve_type(tc, te));  break; } case qoz_Expr_ETry: { qoz_Expr* v = _qoz_ms_1->payload.ETry.f1; qoz_Ty* _qoz_bv_40;
    {
        qoz_Ty* t = qoz_check_synth(tc, env, v); qoz_gc_push_root(&t); qoz_Ty* _qoz_ms_2 = t; qoz_Ty* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_2->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_2->payload.TyAdt.f1; qoz_Ty* _qoz_bv_41;
    {
        if (qoz_strings_eq_raw(name, QOZ_STR_LIT("Result")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_41 = t;
    }
    _qoz_mv_2 = (_qoz_bv_41);  break; } default: { _qoz_mv_2 = (t);  break; } } _qoz_bv_40 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_40);  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.ETuple.f1; qoz_Ty* _qoz_bv_42;
    {
        qoz_Vec__qoz_Ty elem_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Ty(&elem_tys, qoz_check_synth(tc, env, el)); } }_qoz_bv_42 = qoz_ty_ty_tuple_(elem_tys);
    }
    _qoz_mv_1 = (_qoz_bv_42);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_1->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_1->payload.ERecord.f2; _qoz_mv_1 = (qoz_check_synth_record(tc, env, te, fields));  break; } case qoz_Expr_EClosure: { qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_1->payload.EClosure.f3; qoz_Ty* _qoz_bv_43;
    {
        qoz_Vec__qoz_Ty pty = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_Ty* t = qoz_check_resolve_type(tc, cp.ty); qoz_gc_push_root(&t); qoz_vec_push__qoz_Ty(&pty, t); qoz_check_env_define(env, cp.name, t); } }(void)(qoz_check_synth(tc, env, body)); _qoz_bv_43 = qoz_ty_ty_fn_(pty, qoz_check_resolve_type(tc, ret));
    }
    _qoz_mv_1 = (_qoz_bv_43);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; _qoz_mv_1 = (qoz_check_synth_block(tc, env, stmts, tail));  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_1->payload.EIf.f1; qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; qoz_Expr* f = _qoz_ms_1->payload.EIf.f3; _qoz_mv_1 = (qoz_check_synth_if(tc, env, c, t, f));  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; _qoz_mv_1 = (qoz_check_synth_match(tc, env, scrut, arms));  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_1->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_1->payload.EWhile.f2; qoz_Ty* _qoz_bv_44;
    {
        (void)(qoz_check_synth(tc, env, c)); (void)(qoz_check_synth(tc, env, b)); _qoz_bv_44 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_44);  break; } case qoz_Expr_EFor: { qoz_string b1 = _qoz_ms_1->payload.EFor.f1; qoz_string b2 = _qoz_ms_1->payload.EFor.f2; qoz_Expr* it = _qoz_ms_1->payload.EFor.f3; qoz_Expr* b = _qoz_ms_1->payload.EFor.f4; qoz_Ty* _qoz_bv_45;
    {
        qoz_Ty* it_ty = qoz_check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); qoz_check_bind_for_loop(env, b1, b2, it_ty); (void)(qoz_check_synth(tc, env, b)); qoz_check_env_truncate(env, saved_len); _qoz_bv_45 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_45);  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_1->payload.EReturn.f1; qoz_Ty* _qoz_bv_46;
    {
        (void)(qoz_check_synth(tc, env, v)); _qoz_bv_46 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_46);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_1->payload.EDefer.f1; qoz_Ty* _qoz_bv_47;
    {
        (void)(qoz_check_synth(tc, env, b)); _qoz_bv_47 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_47);  break; } case qoz_Expr_ESizeOf: { _qoz_mv_1 = (qoz_ty_ty_int_(64, true));  break; } case qoz_Expr_EArrayLit: { qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.EArrayLit.f1; qoz_Ty* _qoz_bv_48;
    {
        if ((elems.len) == 0) { return qoz_ty_ty_error_();} qoz_Ty* elem_ty = qoz_check_synth(tc, env, elems.data[0]); qoz_gc_push_root(&elem_ty); int64_t i = 1; while (i < (elems.len)) { (void)(qoz_check_synth(tc, env, elems.data[i])); i = i + 1; } qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); qoz_vec_push__qoz_Ty(&args, elem_ty); _qoz_bv_48 = qoz_ty_ty_record_(QOZ_STR_LIT("Vec"), args);
    }
    _qoz_mv_1 = (_qoz_bv_48);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_check_assign(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    if (!qoz_check_is_lvalue_shape(lhs)) { qoz_check_record_error(tc, sp, QOZ_STR_LIT("left-hand side of `=` is not assignable")); } qoz_Ty* lt = qoz_check_synth(tc, env, lhs); qoz_gc_push_root(&lt); qoz_Ty* rt = qoz_check_synth(tc, env, rhs); qoz_gc_push_root(&rt); qoz_Ty* _qoz_ms_1 = lt; switch (_qoz_ms_1->tag) { case qoz_Ty_TyError: { return qoz_ty_ty_unit_(); break; } default: { NULL;  break; } } 0; qoz_Ty* _qoz_ms_2 = rt; switch (_qoz_ms_2->tag) { case qoz_Ty_TyError: { return qoz_ty_ty_unit_(); break; } default: { NULL;  break; } } 0; if (!qoz_ty_ty_assignable(lt, rt)) { qoz_string want = qoz_ty_ty_show(lt); qoz_string got = qoz_ty_ty_show(rt); qoz_string _qoz_bv_49;
    {
        qoz_Strbuf _qoz_sb_310_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_310_30); qoz_strings_sb_append(&_qoz_sb_310_30, QOZ_STR_LIT("cannot assign value of type ")); qoz_strings_sb_append(&_qoz_sb_310_30, got); qoz_strings_sb_append(&_qoz_sb_310_30, QOZ_STR_LIT(" to lhs of type ")); qoz_strings_sb_append(&_qoz_sb_310_30, want); _qoz_bv_49 = qoz_strings_sb_finish(&_qoz_sb_310_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_49); } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_unit_();
}
...
qoz_Ty* qoz_check_synth_unary(qoz_TyContext* tc, qoz_Env* env, qoz_UnaryOp* op, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&op);
    qoz_gc_push_root(&rhs);
    qoz_Ty* t = qoz_check_synth(tc, env, rhs); qoz_gc_push_root(&t); qoz_UnaryOp* _qoz_ms_1 = op; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_1 = (t);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_UnaryOp_UOpDeref: { qoz_Ty* _qoz_ms_2 = t; qoz_Ty* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_2->payload.TyPtr.f0; _qoz_mv_2 = (inner);  break; } default: { _qoz_mv_2 = (qoz_ty_ty_error_());  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_1 = (qoz_ty_ty_ptr_(t));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_check_is_qualified_variant_field(qoz_TyContext* tc, qoz_Expr* base, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_1 = base; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string base_name = _qoz_ms_1->payload.EIdent.f1; _qoz_mv_1 = (qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, base_name) && qoz_map_contains__qoz_string__qoz_string(&tc->variant_of, name));  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_lookup_field(qoz_TyContext* tc, qoz_string struct_name, qoz_Vec__qoz_Ty tyargs, qoz_string field) {
    ...
    _qoz_mv_2 = (_qoz_bv_51);  break; } default: { _qoz_mv_2 = (qoz_ty_ty_error_());  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_apply_subst(qoz_Ty* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_Ty args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_1->payload.TyVar.f1; qoz_Ty* _qoz_bv_52;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_52);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_ty_ty_ptr_(qoz_check_apply_subst(inner, params, args)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty a = _qoz_ms_1->payload.TyAdt.f1; qoz_Ty* _qoz_bv_53;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_53);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty a = _qoz_ms_1->payload.TyRecord.f1; qoz_Ty* _qoz_bv_54;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_54);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty p = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* r = _qoz_ms_1->payload.TyFn.f1; qoz_Ty* _qoz_bv_55;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_55);  break; } default: { _qoz_mv_1 = (t);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_Ty* bt = qoz_check_synth(tc, env, base); qoz_gc_push_root(&bt); (void)(qoz_check_synth(tc, env, idx)); qoz_Ty* _qoz_ms_1 = bt; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (inner);  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; qoz_Ty* _qoz_bv_56;
    {
        if (qoz_strings_eq_raw(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_56 = qoz_ty_ty_error_();
    }
    _qoz_mv_1 = (_qoz_bv_56);  break; } default: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}

bool qoz_check_is_strings_callee(qoz_Expr* callee, qoz_string method) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_1 = callee; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string m = _qoz_ms_1->payload.EField.f2; bool _qoz_bv_57;
    {
        if (!qoz_strings_eq_raw(m, method)) { return false;} qoz_Expr* _qoz_ms_2 = base; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_2->payload.EIdent.f1; _qoz_mv_2 = (qoz_strings_eq_raw(name, QOZ_STR_LIT("strings")));  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_bv_57 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_57);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_check_resolve_callee_fn(qoz_TyContext* tc, qoz_Expr* callee) {
    ...
    _qoz_mv_2 = (_qoz_bv_58);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_check_check_binding_compat(qoz_TyContext* tc, qoz_Span sp, qoz_TypeExpr* te, qoz_Ty* bound, qoz_Ty* vt) {
    ...
    qoz_gc_push_root(&vt);
    qoz_TypeExpr* _qoz_ms_1 = te; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEUnit: { return;  break; } default: { NULL;  break; } } 0; if (!qoz_ty_ty_assignable(bound, vt)) { qoz_string want = qoz_ty_ty_show(bound); qoz_string got = qoz_ty_ty_show(vt); qoz_string _qoz_bv_60;
    {
        qoz_Strbuf _qoz_sb_620_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_620_30); qoz_strings_sb_append(&_qoz_sb_620_30, QOZ_STR_LIT("binding type ")); qoz_strings_sb_append(&_qoz_sb_620_30, want); qoz_strings_sb_append(&_qoz_sb_620_30, QOZ_STR_LIT(" cannot accept value of type ")); qoz_strings_sb_append(&_qoz_sb_620_30, got); _qoz_bv_60 = qoz_strings_sb_finish(&_qoz_sb_620_30);
    }
...
qoz_Option__qoz_TypeExpr* qoz_check_struct_field_typeexpr(qoz_TyContext* tc, qoz_string name, qoz_string field) {
    ...
    _qoz_mv_2 = (_qoz_bv_61);  break; } default: { _qoz_mv_2 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_1 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Vec__qoz_TypeExpr qoz_check_variant_positional_types(qoz_TyContext* tc, qoz_string enum_name, qoz_string variant) {
    ...
    _qoz_mv_2 = (_qoz_bv_62);  break; } default: { _qoz_mv_2 = (empty);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_1 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_call_with_decl(qoz_TyContext* tc, qoz_Span sp, qoz_Decl* d, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Ty arg_tys) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_1 = d; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_1->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DFn.f4; qoz_Ty* _qoz_bv_63;
    {
        if ((arg_tys.len) != (params.len)) { qoz_string _qoz_bv_64;
    {
        qoz_Strbuf _qoz_sb_765_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_765_34); qoz_strings_sb_append(&_qoz_sb_765_34, QOZ_STR_LIT("function expects ")); qoz_strings_sb_append_i64(&_qoz_sb_765_34, (params.len)); qoz_strings_sb_append(&_qoz_sb_765_34, QOZ_STR_LIT(" argument(s), got ")); qoz_strings_sb_append_i64(&_qoz_sb_765_34, (arg_tys.len)); _qoz_bv_64 = qoz_strings_sb_finish(&_qoz_sb_765_34);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_783_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_783_42); qoz_strings_sb_append(&_qoz_sb_783_42, QOZ_STR_LIT("expected ")); qoz_strings_sb_append(&_qoz_sb_783_42, want); qoz_strings_sb_append(&_qoz_sb_783_42, QOZ_STR_LIT(", got ")); qoz_strings_sb_append(&_qoz_sb_783_42, got); _qoz_bv_65 = qoz_strings_sb_finish(&_qoz_sb_783_42);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_814_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_814_42); qoz_strings_sb_append(&_qoz_sb_814_42, QOZ_STR_LIT("type parameter `")); qoz_strings_sb_append(&_qoz_sb_814_42, tp); qoz_strings_sb_append(&_qoz_sb_814_42, QOZ_STR_LIT("` is not constrained by any argument; add an explicit annotation")); _qoz_bv_66 = qoz_strings_sb_finish(&_qoz_sb_814_42);
    }
    ...
    _qoz_mv_1 = (_qoz_bv_63);  break; } case qoz_Decl_DExternal: { qoz_TypeExpr* ret = _qoz_ms_1->payload.DExternal.f4; _qoz_mv_1 = (qoz_check_resolve_type(tc, ret));  break; } default: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_check_compatible_or_refine(qoz_Map__qoz_string__qoz_Ty* env, qoz_string name, qoz_Ty* prior, qoz_Ty* concrete) {
    ...
    qoz_gc_push_root(&concrete);
    if (qoz_ty_ty_eq(prior, concrete)) { return true;} qoz_Ty* _qoz_ms_1 = prior; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_1->payload.TyInt.f0; qoz_Ty* _qoz_ms_2 = concrete; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_2->payload.TyInt.f0; bool _qoz_bv_68;
    {
        if (ci.untyped) { return true;} if (pi.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_68 = false;
    }
    _qoz_mv_2 = (_qoz_bv_68);  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_1->payload.TyFloat.f0; qoz_Ty* _qoz_ms_3 = concrete; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_3->payload.TyFloat.f0; bool _qoz_bv_69;
    {
        if (cf.untyped) { return true;} if (pf.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_69 = false;
    }
    _qoz_mv_3 = (_qoz_bv_69);  break; } default: { _qoz_mv_3 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_ident(qoz_TyContext* tc, qoz_Env* env, qoz_Span span, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&env);
    if (qoz_check_env_has(env, name)) { return qoz_check_env_lookup(env, name);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->fns, name)) { return qoz_ty_ty_error_();} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->externs, name)) { return qoz_ty_ty_error_();} qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, name); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_1->payload.Some.f0; return qoz_check_synth_variant_ctor(tc, name); break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_string _qoz_bv_70;
    {
        qoz_Strbuf _qoz_sb_947_28 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_947_28); qoz_strings_sb_append(&_qoz_sb_947_28, QOZ_STR_LIT("undefined name `")); qoz_strings_sb_append(&_qoz_sb_947_28, name); qoz_strings_sb_append(&_qoz_sb_947_28, QOZ_STR_LIT("`")); _qoz_bv_70 = qoz_strings_sb_finish(&_qoz_sb_947_28);
    }
...
qoz_Ty* qoz_check_synth_binary(qoz_TyContext* tc, qoz_Env* env, qoz_BinaryOp* op, qoz_Expr* l, qoz_Expr* r) {
    ...
    qoz_gc_push_root(&l);
    qoz_gc_push_root(&r);
    qoz_Ty* lt = qoz_check_synth(tc, env, l); qoz_gc_push_root(&lt); (void)(qoz_check_synth(tc, env, r)); qoz_BinaryOp* _qoz_ms_1 = op; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_1 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_1 = (lt);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_1 = (lt);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_block(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_Stmt stmts, qoz_Expr* tail) {
    ...
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex = _qoz_ms_1->payload.SExpr.f1; void* _qoz_bv_71;
    {
...
qoz_Decl* qoz_check_infer_calls_decl(qoz_TyContext* tc, qoz_Decl* d) {
    ...
    _qoz_mv_1 = (_qoz_bv_72);  break; } case qoz_Decl_DConst: { qoz_Span sp = _qoz_ms_1->payload.DConst.f0; qoz_string name = _qoz_ms_1->payload.DConst.f1; qoz_TypeExpr* t = _qoz_ms_1->payload.DConst.f2; qoz_Expr* val = _qoz_ms_1->payload.DConst.f3; qoz_Decl* _qoz_bv_73;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_73);  break; } default: { _qoz_mv_1 = (d);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Expr* qoz_check_infer_calls_expr(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e, qoz_Ty* expected) {
    ...
    _qoz_mv_1 = (_qoz_bv_75);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_1->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_1->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_1->payload.ERecord.f2; qoz_Expr* _qoz_bv_76;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_76);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_1->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_1->payload.EClosure.f3; _qoz_mv_1 = (qoz_make_Expr_EClosure(sp, cps, ret, qoz_check_infer_calls_expr(tc, env, body, qoz_ty_ty_error_())));  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_1->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_Expr* _qoz_bv_77;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_77);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_1->payload.EIf.f0; qoz_Expr* c = _qoz_ms_1->payload.EIf.f1; qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; qoz_Expr* f = _qoz_ms_1->payload.EIf.f3; _qoz_mv_1 = (qoz_make_Expr_EIf(sp, qoz_check_infer_calls_expr(tc, env, c, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, t, expected), qoz_check_infer_calls_expr(tc, env, f, expected)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_Expr* _qoz_bv_78;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_78);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_1->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_1->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_1->payload.EWhile.f2; _qoz_mv_1 = (qoz_make_Expr_EWhile(sp, qoz_check_infer_calls_expr(tc, env, c, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, b, qoz_ty_ty_error_())));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_1->payload.EFor.f0; qoz_string b1 = _qoz_ms_1->payload.EFor.f1; qoz_string b2 = _qoz_ms_1->payload.EFor.f2; qoz_Expr* it = _qoz_ms_1->payload.EFor.f3; qoz_Expr* body = _qoz_ms_1->payload.EFor.f4; qoz_Expr* _qoz_bv_79;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_80);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Stmt* qoz_check_infer_calls_stmt(qoz_TyContext* tc, qoz_Env* env, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_1 = s; qoz_Stmt* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_1->payload.SLet.f0; qoz_string name = _qoz_ms_1->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_1->payload.SLet.f2; qoz_Expr* val = _qoz_ms_1->payload.SLet.f3; qoz_Stmt* _qoz_bv_81;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_81);  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_1->payload.SVar.f0; qoz_string name = _qoz_ms_1->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_1->payload.SVar.f2; qoz_Expr* val = _qoz_ms_1->payload.SVar.f3; qoz_Stmt* _qoz_bv_82;
    {
        qoz_Ty* annotated = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((qoz_check_is_ty_unit_or_error(annotated)) ? qoz_check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); qoz_check_env_define(env, name, binding_ty); _qoz_bv_82 = qoz_make_Stmt_SVar(sp, name, te, new_val);
    }
    _qoz_mv_1 = (_qoz_bv_82);  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_1->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_1->payload.SExpr.f1; _qoz_mv_1 = (qoz_make_Stmt_SExpr(sp, qoz_check_infer_calls_expr(tc, env, x, qoz_ty_ty_error_())));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_check_pick_record_type(qoz_TypeExpr* te, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&expected);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_83;
    {
        if ((args.len) > 0) { return te;} if ((path.len) != 1) { return te;} qoz_Ty* _qoz_ms_2 = expected; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Ty_TyRecord: { qoz_string en = _qoz_ms_2->payload.TyRecord.f0; qoz_Vec__qoz_Ty eargs = _qoz_ms_2->payload.TyRecord.f1; qoz_TypeExpr* _qoz_bv_84;
    {
    ...
    _qoz_mv_2 = (_qoz_bv_84);  break; } default: { _qoz_mv_2 = (te);  break; } } _qoz_bv_83 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_83);  break; } default: { _qoz_mv_1 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_record_field_hint(qoz_TyContext* tc, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    _qoz_mv_3 = (_qoz_bv_86);  break; } default: { _qoz_mv_3 = (qoz_ty_ty_error_());  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } } _qoz_bv_85 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_85);  break; } default: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Expr* qoz_check_rewrite_call(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Ty* expected) {
    ...
    {
        qoz_Strbuf _qoz_sb_1525_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1525_38); qoz_strings_sb_append(&_qoz_sb_1525_38, QOZ_STR_LIT("could not unify argument types with generic parameters of `")); qoz_strings_sb_append(&_qoz_sb_1525_38, fn_name); qoz_strings_sb_append(&_qoz_sb_1525_38, QOZ_STR_LIT("`")); _qoz_bv_88 = qoz_strings_sb_finish(&_qoz_sb_1525_38);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1533_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1533_42); qoz_strings_sb_append(&_qoz_sb_1533_42, QOZ_STR_LIT("type parameter `")); qoz_strings_sb_append(&_qoz_sb_1533_42, tp); qoz_strings_sb_append(&_qoz_sb_1533_42, QOZ_STR_LIT("` of `")); qoz_strings_sb_append(&_qoz_sb_1533_42, fn_name); qoz_strings_sb_append(&_qoz_sb_1533_42, QOZ_STR_LIT("` is not constrained; add an explicit annotation")); _qoz_bv_89 = qoz_strings_sb_finish(&_qoz_sb_1533_42);
    }
    ...
    _qoz_mv_2 = (_qoz_bv_87);  break; } default: { _qoz_mv_2 = (qoz_make_Expr_ECall(sp, new_callee, type_args, new_args));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_1 = (qoz_make_Expr_ECall(sp, new_callee, type_args, new_args));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}

void qoz_check_check_fn_bodies(qoz_TyContext* tc, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_1 = d; switch (_qoz_ms_1->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_1->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DFn.f3; qoz_Expr* body = _qoz_ms_1->payload.DFn.f5; {
    ...
    0;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DStruct: { NULL;  break; } case qoz_Decl_DEnum: { NULL;  break; } case qoz_Decl_DTypeAlias: { NULL;  break; } case qoz_Decl_DConst: { qoz_Expr* val = _qoz_ms_1->payload.DConst.f3; void* _qoz_bv_90;
    {
...
void qoz_check_validate_signatures(qoz_TyContext* tc, qoz_File f) {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DExternal.f4; void* _qoz_bv_91;
    {
    ...
    _qoz_bv_91;  break; } case qoz_Decl_DStruct: { qoz_Vec__qoz_string tparams = _qoz_ms_1->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_1->payload.DStruct.f3; {
    ...
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_1->payload.DConst.f2; void* _qoz_bv_92;
    {
...
qoz_string qoz_emit_variant_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); qoz_string _qoz_mv_4 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_4->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_4 = (method);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_4 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_93 = _qoz_mv_4;
    }
    _qoz_mv_3 = (_qoz_bv_93);  break; } default: { _qoz_mv_3 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_1->payload.EPath.f1; qoz_string _qoz_bv_94;
    {
        if ((segs.len) != 2) { return QOZ_STR_LIT("");} if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, segs.data[0])) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_5 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, segs.data[1]); qoz_string _qoz_mv_5 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_5->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_5 = (segs.data[1]);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_5 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_94 = _qoz_mv_5;
    }
    _qoz_mv_1 = (_qoz_bv_94);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_generic_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_Expr* _qoz_ms_1 = callee; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_1->payload.EIdent.f1; _qoz_mv_1 = (name);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string method = _qoz_ms_1->payload.EField.f2; qoz_Expr* _qoz_ms_2 = base; qoz_string _qoz_mv_2 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_2->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_2->payload.EIdent.f1; qoz_string _qoz_bv_95;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, pkg)) { qoz_Option__qoz_string* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); switch (_qoz_ms_3->tag) { case qoz_Option__qoz_string_Some: { return method; break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } _qoz_bv_95 = QOZ_STR_LIT("");
    }
    _qoz_mv_2 = (_qoz_bv_95);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_1->payload.EPath.f1; qoz_string _qoz_bv_96;
    {
        if ((segs.len) == 2) { qoz_string pkg = segs.data[0]; qoz_string method = segs.data[1]; if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, pkg)) { qoz_Option__qoz_string* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); switch (_qoz_ms_4->tag) { case qoz_Option__qoz_string_Some: { return method; break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } } _qoz_bv_96 = QOZ_STR_LIT("");
    }
    _qoz_mv_1 = (_qoz_bv_96);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_substitute_type(qoz_Emitter* e, qoz_TypeExpr* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    _qoz_mv_1 = (_qoz_bv_98);  break; } case qoz_TypeExpr_TENamed: { qoz_Span span = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr t_args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_99;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_99);  break; } case qoz_TypeExpr_TEFn: { qoz_Span span = _qoz_ms_1->payload.TEFn.f0; qoz_Vec__qoz_TypeExpr fparams = _qoz_ms_1->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.TEFn.f2; qoz_TypeExpr* _qoz_bv_100;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_100);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Expr* qoz_emit_substitute_expr(qoz_Emitter* e, qoz_Expr* x, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    _qoz_mv_1 = (_qoz_bv_102);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_1->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_1->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_1->payload.ERecord.f2; qoz_Expr* _qoz_bv_103;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_103);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_1->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_1->payload.EClosure.f3; qoz_Expr* _qoz_bv_104;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_104);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_1->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_Expr* _qoz_bv_105;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_105);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_1->payload.EIf.f0; qoz_Expr* c = _qoz_ms_1->payload.EIf.f1; qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; qoz_Expr* f = _qoz_ms_1->payload.EIf.f3; _qoz_mv_1 = (qoz_make_Expr_EIf(sp, qoz_emit_substitute_expr(e, c, params, args), qoz_emit_substitute_expr(e, t, params, args), qoz_emit_substitute_expr(e, f, params, args)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_Expr* _qoz_bv_106;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_107);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_operator_first_param_type_name(qoz_TypeExpr* te) {
    ...
    _qoz_mv_2 = (_qoz_bv_108);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_string _qoz_bv_109;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_109 = QOZ_STR_LIT("");
    }
    _qoz_mv_1 = (_qoz_bv_109);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_result_mangle_for(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_string _qoz_bv_111;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_111);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_expr(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_emit_push(e, _qoz_bv_132);  break; } case qoz_Option__qoz_string_None: { qoz_emit_push(e, name);  break; } } 0;  break; } case qoz_Expr_EString: { qoz_string text = _qoz_ms_1->payload.EString.f1; qoz_string _qoz_bv_133;
    {
    ...
    qoz_emit_push(e, _qoz_bv_133);  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_1->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_1->payload.EBinary.f3; qoz_emit_emit_binary(e, op, lhs, rhs);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; {
    ...
    _qoz_mv_4 = (_qoz_bv_134);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_4; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_unary_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_136;
    {
    ...
    {
        qoz_Strbuf _qoz_sb_1385_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1385_17); qoz_strings_sb_append(&_qoz_sb_1385_17, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1385_17, tc); qoz_strings_sb_append(&_qoz_sb_1385_17, QOZ_STR_LIT(")")); _qoz_bv_140 = qoz_strings_sb_finish(&_qoz_sb_1385_17);
    }
...
qoz_string qoz_emit_infer_expr_ctype(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_1 = ex; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Expr_EAssign: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EReturn: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EWhile: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EFor: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EDefer: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_string _qoz_bv_142;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_142);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_string _qoz_bv_143;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_143);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_1->payload.EPath.f0; _qoz_mv_1 = (qoz_emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported")));  break; } default: { _qoz_mv_1 = (qoz_emit_c_type_for(e, qoz_emit_infer_value_te(e, ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_bare_enum_for_pat(qoz_Emitter* e, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_1 = pat; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.PatVariant.f1; qoz_string _qoz_bv_144;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, path.data[(path.len) - 1]); qoz_string _qoz_mv_2 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_144 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_144);  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_1->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_3 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_3->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_3 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_emit_die(qoz_Span sp, qoz_string msg) {
    ...
    {
        qoz_Strbuf _qoz_sb_1469_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1469_17); qoz_strings_sb_append(&_qoz_sb_1469_17, sp.file); qoz_strings_sb_append(&_qoz_sb_1469_17, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_1469_17, sp.line); qoz_strings_sb_append(&_qoz_sb_1469_17, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_1469_17, sp.col); qoz_strings_sb_append(&_qoz_sb_1469_17, QOZ_STR_LIT(": emit error: ")); qoz_strings_sb_append(&_qoz_sb_1469_17, msg); _qoz_bv_145 = qoz_strings_sb_finish(&_qoz_sb_1469_17);
    }
...
void qoz_emit_assert_plain_assign(qoz_AssignOp* op, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_AssignOp* _qoz_ms_1 = op; switch (_qoz_ms_1->tag) { case qoz_AssignOp_AOpSet: { NULL;  break; } default: { void* _qoz_bv_146;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("internal: compound assignment reached emit; parse should have desugared it"))); _qoz_bv_146 = NULL;
    }
    _qoz_bv_146;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* qoz_emit_infer_base_typeexpr(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_1 = base; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_1->payload.EIdent.f0; qoz_string ident = _qoz_ms_1->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_Option__qoz_string* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, ident); qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_3->payload.Some.f0; qoz_TypeExpr* _qoz_bv_147;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, en); _qoz_bv_147 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_3 = (_qoz_bv_147);  break; } case qoz_Option__qoz_string_None: { qoz_TypeExpr* _qoz_bv_148;
    {
        qoz_string _qoz_bv_149;
    {
        qoz_Strbuf _qoz_sb_1498_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1498_38); qoz_strings_sb_append(&_qoz_sb_1498_38, QOZ_STR_LIT("identifier `")); qoz_strings_sb_append(&_qoz_sb_1498_38, ident); qoz_strings_sb_append(&_qoz_sb_1498_38, QOZ_STR_LIT("` has no known TypeExpr (not a local, parameter, or variant)")); _qoz_bv_149 = qoz_strings_sb_finish(&_qoz_sb_1498_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_149)); _qoz_bv_148 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_148);  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* b = _qoz_ms_1->payload.EField.f1; qoz_string n = _qoz_ms_1->payload.EField.f2; qoz_TypeExpr* _qoz_bv_150;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); _qoz_bv_150 = qoz_emit_field_typeexpr_for(e, bte, n, sp);
    }
    _qoz_mv_1 = (_qoz_bv_150);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_4 = op; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_151;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_base_typeexpr(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_5 = inner; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_5->payload.TEPtr.f1; _qoz_mv_5 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_152;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("dereference of non-pointer base in EField/EIndex"))); _qoz_bv_152 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_152);  break; } } _qoz_bv_151 = _qoz_mv_5;
    }
    _qoz_mv_4 = (_qoz_bv_151);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_4 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_infer_base_typeexpr(e, rhs)));  break; } default: { qoz_TypeExpr* _qoz_bv_153;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("unary operator does not yield a base TypeExpr"))); _qoz_bv_153 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_153);  break; } } _qoz_mv_1 = (_qoz_mv_4);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_1->payload.ECall.f0; qoz_Expr* c = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr va = _qoz_ms_1->payload.ECall.f3; _qoz_mv_1 = (qoz_emit_call_return_te(e, c, ta, va, sp));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_1->payload.ECast.f2; _qoz_mv_1 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_1->payload.ERecord.f1; _qoz_mv_1 = (t);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_1->payload.EIndex.f0; qoz_Expr* b = _qoz_ms_1->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_154;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_6 = bte; qoz_TypeExpr* _qoz_mv_6 = NULL; switch (_qoz_ms_6->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_6->payload.TEPtr.f1; _qoz_mv_6 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_6->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_6->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_155;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into non-Vec/non-pointer base"))); _qoz_bv_155 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_6 = (_qoz_bv_155);  break; } default: { qoz_TypeExpr* _qoz_bv_156;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into unrecognised base"))); _qoz_bv_156 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_6 = (_qoz_bv_156);  break; } } _qoz_bv_154 = _qoz_mv_6;
    }
    _qoz_mv_1 = (_qoz_bv_154);  break; } default: { qoz_TypeExpr* _qoz_bv_157;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(base), QOZ_STR_LIT("base expression has no resolvable TypeExpr"))); _qoz_bv_157 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(base));
    }
    _qoz_mv_1 = (_qoz_bv_157);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_TypeExpr* _qoz_ms_1 = base_te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_1->payload.TEPtr.f1; _qoz_mv_1 = (inner);  break; } default: { _qoz_mv_1 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_1; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_2 = unwrapped; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_158;
    {
        if ((path.len) < 1) { qoz_string _qoz_bv_159;
    {
        qoz_Strbuf _qoz_sb_1579_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1579_34); qoz_strings_sb_append(&_qoz_sb_1579_34, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1579_34, field); qoz_strings_sb_append(&_qoz_sb_1579_34, QOZ_STR_LIT("` on TypeExpr with empty path")); _qoz_bv_159 = qoz_strings_sb_finish(&_qoz_sb_1579_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_159)); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = qoz_emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_3 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_3; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_4 = decl_opt; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_4->payload.Some.f0; qoz_Decl* _qoz_ms_5 = decl; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_5->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_5->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_160;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_strings_eq_raw(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }qoz_string _qoz_bv_161;
    {
        qoz_Strbuf _qoz_sb_1599_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1599_38); qoz_strings_sb_append(&_qoz_sb_1599_38, QOZ_STR_LIT("struct `")); qoz_strings_sb_append(&_qoz_sb_1599_38, lookup); qoz_strings_sb_append(&_qoz_sb_1599_38, QOZ_STR_LIT("` has no field `")); qoz_strings_sb_append(&_qoz_sb_1599_38, field); qoz_strings_sb_append(&_qoz_sb_1599_38, QOZ_STR_LIT("`")); _qoz_bv_161 = qoz_strings_sb_finish(&_qoz_sb_1599_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_161)); _qoz_bv_160 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_160);  break; } default: { qoz_TypeExpr* _qoz_bv_162;
    {
        qoz_string _qoz_bv_163;
    {
        qoz_Strbuf _qoz_sb_1593_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1593_38); qoz_strings_sb_append(&_qoz_sb_1593_38, QOZ_STR_LIT("decl `")); qoz_strings_sb_append(&_qoz_sb_1593_38, lookup); qoz_strings_sb_append(&_qoz_sb_1593_38, QOZ_STR_LIT("` is not a struct")); _qoz_bv_163 = qoz_strings_sb_finish(&_qoz_sb_1593_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_163)); _qoz_bv_162 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_162);  break; } } _qoz_mv_4 = (_qoz_mv_5);  break; } case qoz_Option__qoz_Decl_None: { qoz_TypeExpr* _qoz_bv_164;
    {
        qoz_string _qoz_bv_165;
    {
        qoz_Strbuf _qoz_sb_1609_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1609_34); qoz_strings_sb_append(&_qoz_sb_1609_34, QOZ_STR_LIT("unknown struct `")); qoz_strings_sb_append(&_qoz_sb_1609_34, lookup); qoz_strings_sb_append(&_qoz_sb_1609_34, QOZ_STR_LIT("` for field `.")); qoz_strings_sb_append(&_qoz_sb_1609_34, field); qoz_strings_sb_append(&_qoz_sb_1609_34, QOZ_STR_LIT("`")); _qoz_bv_165 = qoz_strings_sb_finish(&_qoz_sb_1609_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_165)); _qoz_bv_164 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_164);  break; } } _qoz_bv_158 = _qoz_mv_4;
    }
    _qoz_mv_2 = (_qoz_bv_158);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_2->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_166;
    {
        int64_t idx = qoz_emit_tuple_field_index(field); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} qoz_string _qoz_bv_167;
    {
        qoz_Strbuf _qoz_sb_1617_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1617_30); qoz_strings_sb_append(&_qoz_sb_1617_30, QOZ_STR_LIT("tuple has no field `.")); qoz_strings_sb_append(&_qoz_sb_1617_30, field); qoz_strings_sb_append(&_qoz_sb_1617_30, QOZ_STR_LIT("`")); _qoz_bv_167 = qoz_strings_sb_finish(&_qoz_sb_1617_30);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_167)); _qoz_bv_166 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_2 = (_qoz_bv_166);  break; } default: { qoz_TypeExpr* _qoz_bv_168;
    {
        qoz_string _qoz_bv_169;
    {
        qoz_Strbuf _qoz_sb_1611_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1611_30); qoz_strings_sb_append(&_qoz_sb_1611_30, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1611_30, field); qoz_strings_sb_append(&_qoz_sb_1611_30, QOZ_STR_LIT("` on a non-named base")); _qoz_bv_169 = qoz_strings_sb_finish(&_qoz_sb_1611_30);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_169)); _qoz_bv_168 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_2 = (_qoz_bv_168);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_2;
}
...
qoz_TypeExpr* qoz_emit_infer_value_te(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Expr* _qoz_ms_1 = v; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_1->payload.ECast.f2; _qoz_mv_1 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_1->payload.ERecord.f1; qoz_TypeExpr* _qoz_bv_170;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__int64_t__qoz_TypeExpr(&e->expr_types, qoz_emit_expr_id(v)); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* cte = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (cte);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_2 = (t);  break; } } qoz_TypeExpr* cached = _qoz_mv_2; qoz_gc_push_root(&cached); _qoz_bv_170 = qoz_emit_prefer_typed_record(e, t, cached);
    }
    _qoz_mv_1 = (_qoz_bv_170);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; _qoz_mv_1 = (qoz_emit_field_typeexpr_for(e, qoz_emit_infer_base_typeexpr(e, base), name, sp));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_1->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_171;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_3 = bte; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_3->payload.TEPtr.f1; _qoz_mv_3 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_3->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_3->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_172;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into non-Vec base; cannot determine binding type"))); _qoz_bv_172 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_172);  break; } default: { qoz_TypeExpr* _qoz_bv_173;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into unrecognised base"))); _qoz_bv_173 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_173);  break; } } _qoz_bv_171 = _qoz_mv_3;
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1734_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1734_34); qoz_strings_sb_append(&_qoz_sb_1734_34, QOZ_STR_LIT("let-binding value references unknown name `")); qoz_strings_sb_append(&_qoz_sb_1734_34, name); qoz_strings_sb_append(&_qoz_sb_1734_34, QOZ_STR_LIT("`")); _qoz_bv_175 = qoz_strings_sb_finish(&_qoz_sb_1734_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_175)); _qoz_bv_174 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_174);  break; } } _qoz_mv_1 = (_qoz_mv_4);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_1->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr vargs = _qoz_ms_1->payload.ECall.f3; _qoz_mv_1 = (qoz_emit_call_return_te(e, callee, type_args, vargs, sp));  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_1->payload.EInt.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_1->payload.EFloat.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("f64")));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_1->payload.EString.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_1->payload.EBool.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_1->payload.EChar.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_1->payload.ENil.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_single_named_te(sp, QOZ_STR_LIT("void"))));  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_5 = op; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_5 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_infer_value_te(e, rhs)));  break; } case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_176;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_value_te(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_6 = inner; qoz_TypeExpr* _qoz_mv_6 = NULL; switch (_qoz_ms_6->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_6->payload.TEPtr.f1; _qoz_mv_6 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_177;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding dereferences a non-pointer"))); _qoz_bv_177 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_6 = (_qoz_bv_177);  break; } } _qoz_bv_176 = _qoz_mv_6;
    }
    _qoz_mv_5 = (_qoz_bv_176);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_5 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_UnaryOp_UOpNeg: { _qoz_mv_5 = (qoz_emit_infer_value_te(e, rhs));  break; } } _qoz_mv_1 = (_qoz_mv_5);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_1->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_1->payload.EBinary.f2; qoz_BinaryOp* _qoz_ms_7 = op; qoz_TypeExpr* _qoz_mv_7 = NULL; switch (_qoz_ms_7->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } default: { _qoz_mv_7 = (qoz_emit_infer_value_te(e, l));  break; } } _qoz_mv_1 = (_qoz_mv_7);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_TypeExpr* _qoz_bv_178;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_ingest_stmt_locals(e, s); } }_qoz_bv_178 = qoz_emit_infer_value_te(e, tail);
    }
    _qoz_mv_1 = (_qoz_bv_178);  break; } case qoz_Expr_EIf: { qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; _qoz_mv_1 = (qoz_emit_infer_value_te(e, t));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_TypeExpr* _qoz_bv_179;
    {
        if ((arms.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); qoz_string enum_name = ((qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : qoz_emit_enum_lookup_name(e, scrut, bare_enum)); qoz_emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_179 = qoz_emit_infer_value_te(e, arms.data[0].body);
    }
    _qoz_mv_1 = (_qoz_bv_179);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_1->payload.ESizeOf.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_1->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.ETuple.f1; qoz_TypeExpr* _qoz_bv_180;
    {
        qoz_Vec__qoz_TypeExpr ets = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ets, qoz_emit_infer_value_te(e, el)); } }_qoz_bv_180 = qoz_make_TypeExpr_TETuple(sp, ets);
    }
    _qoz_mv_1 = (_qoz_bv_180);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_1->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_TypeExpr* _qoz_bv_181;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&pte, cp.ty); } }_qoz_bv_181 = qoz_make_TypeExpr_TEFn(sp, pte, ret);
    }
    _qoz_mv_1 = (_qoz_bv_181);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_1->payload.ETry.f0; qoz_Expr* value = _qoz_ms_1->payload.ETry.f1; qoz_TypeExpr* _qoz_bv_182;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_value_te(e, value); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_8 = inner; qoz_TypeExpr* _qoz_mv_8 = NULL; switch (_qoz_ms_8->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_8->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_8->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_183;
    {
        if ((args.len) == 2) { if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, QOZ_STR_LIT("Result"))) { return args.data[0];} } } _qoz_bv_183 = inner;
    }
    _qoz_mv_8 = (_qoz_bv_183);  break; } default: { _qoz_mv_8 = (inner);  break; } } _qoz_bv_182 = _qoz_mv_8;
    }
    _qoz_mv_1 = (_qoz_bv_182);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_1->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.EArrayLit.f1; qoz_TypeExpr* _qoz_bv_184;
    {
        if ((elems.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("empty array literal: element type cannot be inferred"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_TypeExpr* elem_te = qoz_emit_infer_value_te(e, elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Vec__qoz_TypeExpr args = qoz_vec_make__qoz_TypeExpr(); qoz_vec_push__qoz_TypeExpr(&args, elem_te); qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("Vec")); _qoz_bv_184 = qoz_make_TypeExpr_TENamed(sp, path, args);
    }
    _qoz_mv_1 = (_qoz_bv_184);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_1->payload.EAssign.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_1->payload.EWhile.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_1->payload.EFor.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_1->payload.EReturn.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_1->payload.EDefer.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_1->payload.EPath.f0; qoz_TypeExpr* _qoz_bv_185;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported (expected pkg.fn or a record name)"))); _qoz_bv_185 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_185);  break; } default: { qoz_TypeExpr* _qoz_bv_186;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(v), QOZ_STR_LIT("let-binding value shape not handled by inference"))); _qoz_bv_186 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(v));
    }
    _qoz_mv_1 = (_qoz_bv_186);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_call_return_te(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    ...
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_2->payload.Some.f0; qoz_Decl* _qoz_ms_3 = d; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_3->payload.DFn.f2; qoz_TypeExpr* ret = _qoz_ms_3->payload.DFn.f4; qoz_TypeExpr* _qoz_bv_189;
    {
        if (((type_args.len) == (tparams.len)) && ((tparams.len) > 0)) { return qoz_emit_substitute_type(e, ret, tparams, type_args);} _qoz_bv_189 = ret;
    }
    _qoz_mv_3 = (_qoz_bv_189);  break; } default: { qoz_TypeExpr* _qoz_bv_190;
    {
        qoz_string _qoz_bv_191;
    {
        qoz_Strbuf _qoz_sb_2018_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2018_34); qoz_strings_sb_append(&_qoz_sb_2018_34, QOZ_STR_LIT("`")); qoz_strings_sb_append(&_qoz_sb_2018_34, name); qoz_strings_sb_append(&_qoz_sb_2018_34, QOZ_STR_LIT("` is in generic_fn_decls but not a DFn")); _qoz_bv_191 = qoz_strings_sb_finish(&_qoz_sb_2018_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_191)); _qoz_bv_190 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_190);  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_TypeExpr* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, name); qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_4->payload.Some.f0; _qoz_mv_4 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_192;
    {
        qoz_string _qoz_bv_193;
    {
        qoz_Strbuf _qoz_sb_2017_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2017_34); qoz_strings_sb_append(&_qoz_sb_2017_34, QOZ_STR_LIT("call to unknown function `")); qoz_strings_sb_append(&_qoz_sb_2017_34, name); qoz_strings_sb_append(&_qoz_sb_2017_34, QOZ_STR_LIT("` (no DFn, DExternal, or builtin matched)")); _qoz_bv_193 = qoz_strings_sb_finish(&_qoz_sb_2017_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_193)); _qoz_bv_192 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_192);  break; } } _qoz_mv_2 = (_qoz_mv_4);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_2;
}
...
void qoz_emit_emit_stmt_inner(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_Stmt* _qoz_ms_1 = s; switch (_qoz_ms_1->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_1->payload.SLet.f1; qoz_TypeExpr* ty = _qoz_ms_1->payload.SLet.f2; qoz_Expr* value = _qoz_ms_1->payload.SLet.f3; {
        qoz_TypeExpr* bind_te = qoz_emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_strings_eq_raw(name, QOZ_STR_LIT("_"))) { qoz_emit_push(e, QOZ_STR_LIT("(void)(")); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = qoz_emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_194;
    {
        qoz_Strbuf _qoz_sb_2080_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2080_17); qoz_strings_sb_append(&_qoz_sb_2080_17, ct); qoz_strings_sb_append(&_qoz_sb_2080_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2080_17, name); qoz_strings_sb_append(&_qoz_sb_2080_17, QOZ_STR_LIT(" = ")); _qoz_bv_194 = qoz_strings_sb_finish(&_qoz_sb_2080_17);
    }
    qoz_emit_push(e, _qoz_bv_194); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (qoz_emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_195;
    {
        qoz_Strbuf _qoz_sb_2094_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2094_21); qoz_strings_sb_append(&_qoz_sb_2094_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2094_21, name); qoz_strings_sb_append(&_qoz_sb_2094_21, QOZ_STR_LIT("); ")); _qoz_bv_195 = qoz_strings_sb_finish(&_qoz_sb_2094_21);
    }
    qoz_emit_push(e, _qoz_bv_195); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_1->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_1->payload.SVar.f2; qoz_Expr* value = _qoz_ms_1->payload.SVar.f3; {
        qoz_TypeExpr* bind_te = qoz_emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_strings_eq_raw(name, QOZ_STR_LIT("_"))) { qoz_emit_push(e, QOZ_STR_LIT("(void)(")); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = qoz_emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_196;
    {
        qoz_Strbuf _qoz_sb_2107_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2107_17); qoz_strings_sb_append(&_qoz_sb_2107_17, ct); qoz_strings_sb_append(&_qoz_sb_2107_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2107_17, name); qoz_strings_sb_append(&_qoz_sb_2107_17, QOZ_STR_LIT(" = ")); _qoz_bv_196 = qoz_strings_sb_finish(&_qoz_sb_2107_17);
    }
    qoz_emit_push(e, _qoz_bv_196); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (qoz_emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_197;
    {
        qoz_Strbuf _qoz_sb_2101_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2101_21); qoz_strings_sb_append(&_qoz_sb_2101_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2101_21, name); qoz_strings_sb_append(&_qoz_sb_2101_21, QOZ_STR_LIT("); ")); _qoz_bv_197 = qoz_strings_sb_finish(&_qoz_sb_2101_21);
    }
    qoz_emit_push(e, _qoz_bv_197); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
...
qoz_string qoz_emit_qualified_call_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_198 = QOZ_STR_LIT("");
    }
    _qoz_mv_2 = (_qoz_bv_198);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_field(qoz_Emitter* e, qoz_Expr* base, qoz_string name) {
    ...
    qoz_Expr* _qoz_ms_1 = base; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_1->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_201;
    {
        qoz_Strbuf _qoz_sb_2377_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2377_25); qoz_strings_sb_append(&_qoz_sb_2377_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2377_25, enum_name); qoz_strings_sb_append(&_qoz_sb_2377_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2377_25, name); qoz_strings_sb_append(&_qoz_sb_2377_25, QOZ_STR_LIT("()")); _qoz_bv_201 = qoz_strings_sb_finish(&_qoz_sb_2377_25);
    }
    qoz_emit_push(e, _qoz_bv_201); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } 0;  break; } default: { NULL;  break; } } 0; qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_202;
    {
        qoz_Strbuf _qoz_sb_2388_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2388_13); qoz_strings_sb_append(&_qoz_sb_2388_13, op); qoz_strings_sb_append(&_qoz_sb_2388_13, name); _qoz_bv_202 = qoz_strings_sb_finish(&_qoz_sb_2388_13);
    }
    qoz_emit_push(e, _qoz_bv_202); 
    return;
}
...
qoz_TypeExpr* qoz_emit_base_type_for_walk(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    {
        qoz_TypeExpr* bte = qoz_emit_base_type_for_walk(e, b); qoz_gc_push_root(&bte); _qoz_bv_203 = qoz_emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_1 = (_qoz_bv_203);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_3 = op; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_204;
    {
        qoz_TypeExpr* inner = qoz_emit_base_type_for_walk(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_4 = inner; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_4->payload.TEPtr.f1; _qoz_mv_4 = (t);  break; } default: { _qoz_mv_4 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_204 = _qoz_mv_4;
    }
    _qoz_mv_3 = (_qoz_bv_204);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_3 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_base_type_for_walk(e, rhs)));  break; } default: { _qoz_mv_3 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for_no_die(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base_te);
    qoz_TypeExpr* _qoz_ms_1 = base_te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_1->payload.TEPtr.f1; _qoz_mv_1 = (inner);  break; } default: { _qoz_mv_1 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_1; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_2 = unwrapped; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_205;
    {
        if ((path.len) < 1) { return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = qoz_emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_3 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_3; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_4 = decl_opt; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_4->payload.Some.f0; qoz_Decl* _qoz_ms_5 = decl; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_5->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_5->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_206;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_strings_eq_raw(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }_qoz_bv_206 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_206);  break; } default: { _qoz_mv_5 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_4 = (_qoz_mv_5);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_4 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_205 = _qoz_mv_4;
    }
    _qoz_mv_2 = (_qoz_bv_205);  break; } default: { _qoz_mv_2 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_2;
}
...
void qoz_emit_emit_assign(qoz_Emitter* e, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_Expr* _qoz_ms_1 = lhs; switch (_qoz_ms_1->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_1->payload.EIndex.f2; {
        qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_2 = te; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { qoz_emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); qoz_string k_m = qoz_emit_mangle_type(e, args.data[0]); qoz_string v_m = qoz_emit_mangle_type(e, args.data[1]); qoz_string _qoz_bv_207;
    {
        qoz_Strbuf _qoz_sb_2529_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2529_25); qoz_strings_sb_append(&_qoz_sb_2529_25, QOZ_STR_LIT("qoz_map_set__")); qoz_strings_sb_append(&_qoz_sb_2529_25, k_m); qoz_strings_sb_append(&_qoz_sb_2529_25, QOZ_STR_LIT("__")); qoz_strings_sb_append(&_qoz_sb_2529_25, v_m); qoz_strings_sb_append(&_qoz_sb_2529_25, QOZ_STR_LIT("(&")); _qoz_bv_207 = qoz_strings_sb_finish(&_qoz_sb_2529_25);
    }
    qoz_emit_push(e, _qoz_bv_207); qoz_emit_emit_expr(e, base); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; 
    }
...
qoz_TypeExpr* qoz_emit_lvalue_hint(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&lhs);
    qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Expr* _qoz_ms_1 = lhs; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; qoz_TypeExpr* _qoz_bv_208;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); _qoz_bv_208 = qoz_emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_1 = (_qoz_bv_208);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_209;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_2 = bte; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_2->payload.TEPtr.f1; _qoz_mv_2 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_210;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_210 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_2 = (_qoz_bv_210);  break; } default: { _qoz_mv_2 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_209 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_209);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_1->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_3 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_index(qoz_Emitter* e, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&idx);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_1 = te; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(n, QOZ_STR_LIT("Vec"))) { qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_211;
    {
        qoz_Strbuf _qoz_sb_2523_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2523_25); qoz_strings_sb_append(&_qoz_sb_2523_25, op); qoz_strings_sb_append(&_qoz_sb_2523_25, QOZ_STR_LIT("data[")); _qoz_bv_211 = qoz_strings_sb_finish(&_qoz_sb_2523_25);
    }
    qoz_emit_push(e, _qoz_bv_211); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT("]")); return;} } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_emit_expr(e, base); qoz_emit_push(e, QOZ_STR_LIT("[")); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT("]")); 
    return;
}
...
void qoz_emit_emit_hash_builtin(qoz_Emitter* e, qoz_Expr* arg) {
    ...
    qoz_string ct = qoz_emit_infer_expr_ctype(e, arg); if (qoz_strings_eq_raw(ct, QOZ_STR_LIT("qoz_string"))) { qoz_emit_push(e, QOZ_STR_LIT("qoz_string_hash(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, ct); if (!qoz_strings_eq_raw(record_name, QOZ_STR_LIT(""))) { qoz_string _qoz_bv_212;
    {
        qoz_Strbuf _qoz_sb_2647_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2647_17); qoz_strings_sb_append(&_qoz_sb_2647_17, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_2647_17, record_name); qoz_strings_sb_append(&_qoz_sb_2647_17, QOZ_STR_LIT("(")); _qoz_bv_212 = qoz_strings_sb_finish(&_qoz_sb_2647_17);
    }
    qoz_emit_push(e, _qoz_bv_212); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_emit_push(e, QOZ_STR_LIT("(uint64_t)(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void qoz_emit_emit_call(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_strings_eq_raw(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_4->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_4->payload.Some.f0; {
        qoz_string _qoz_bv_215;
    {
        qoz_Strbuf _qoz_sb_2740_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2740_21); qoz_strings_sb_append(&_qoz_sb_2740_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2740_21, enum_name); qoz_strings_sb_append(&_qoz_sb_2740_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2740_21, variant_name); qoz_strings_sb_append(&_qoz_sb_2740_21, QOZ_STR_LIT("(")); _qoz_bv_215 = qoz_strings_sb_finish(&_qoz_sb_2740_21);
    }
    qoz_emit_push(e, _qoz_bv_215); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } if ((type_args.len) > 0) { qoz_Expr* _qoz_ms_5 = callee; switch (_qoz_ms_5->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_5->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { qoz_string mi = qoz_emit_mangle_inst(e, name, type_args); qoz_string _qoz_bv_216;
    {
        qoz_Strbuf _qoz_sb_2759_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2759_25); qoz_strings_sb_append(&_qoz_sb_2759_25, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2759_25, mi); qoz_strings_sb_append(&_qoz_sb_2759_25, QOZ_STR_LIT("(")); _qoz_bv_216 = qoz_strings_sb_finish(&_qoz_sb_2759_25);
    }
    qoz_emit_push(e, _qoz_bv_216); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_6 = callee; switch (_qoz_ms_6->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_6->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_7 = qoz_map_get__qoz_string__qoz_string(&e->externs, name); switch (_qoz_ms_7->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_7->payload.Some.f0; {
        qoz_string _qoz_bv_217;
    {
        qoz_Strbuf _qoz_sb_2781_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2781_21); qoz_strings_sb_append(&_qoz_sb_2781_21, sym); qoz_strings_sb_append(&_qoz_sb_2781_21, QOZ_STR_LIT("(")); _qoz_bv_217 = qoz_strings_sb_finish(&_qoz_sb_2781_21);
    }
    qoz_emit_push(e, _qoz_bv_217); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_8 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name); switch (_qoz_ms_8->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_8->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { qoz_emit_emit_value_with_hint(e, a, hints.data[i]); }  else { qoz_emit_emit_expr(e, a); } i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
...
qoz_TypeExpr* qoz_emit_callee_value_typeexpr(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_1 = callee; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_1->payload.EIdent.f0; qoz_string name = _qoz_ms_1->payload.EIdent.f1; qoz_TypeExpr* _qoz_bv_218;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_2->payload.Some.f0; return te;  break; } default: { NULL;  break; } } 0; _qoz_bv_218 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_218);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(callee)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_binary(qoz_Emitter* e, qoz_BinaryOp* op, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    {
        qoz_string _qoz_bv_220;
    {
        qoz_Strbuf _qoz_sb_2925_57 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2925_57); qoz_strings_sb_append(&_qoz_sb_2925_57, QOZ_STR_LIT("operator `")); qoz_strings_sb_append(&_qoz_sb_2925_57, op_text); qoz_strings_sb_append(&_qoz_sb_2925_57, QOZ_STR_LIT("` for `")); qoz_strings_sb_append(&_qoz_sb_2925_57, tname); qoz_strings_sb_append(&_qoz_sb_2925_57, QOZ_STR_LIT("` has no recorded return type")); _qoz_bv_220 = qoz_strings_sb_finish(&_qoz_sb_2925_57);
    }
    (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(lhs), _qoz_bv_220)); _qoz_bv_219 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(lhs));
    }
    _qoz_mv_3 = (_qoz_bv_219);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_3; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_221;
    {
        qoz_Strbuf _qoz_sb_2935_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2935_25); qoz_strings_sb_append(&_qoz_sb_2935_25, QOZ_STR_LIT("_qoz_byval_")); qoz_strings_sb_append(&_qoz_sb_2935_25, fn_name); qoz_strings_sb_append(&_qoz_sb_2935_25, QOZ_STR_LIT("(")); _qoz_bv_221 = qoz_strings_sb_finish(&_qoz_sb_2935_25);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3048_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3048_21); qoz_strings_sb_append(&_qoz_sb_3048_21, QOZ_STR_LIT("qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3048_21, record_name); qoz_strings_sb_append(&_qoz_sb_3048_21, QOZ_STR_LIT("(")); _qoz_bv_222 = qoz_strings_sb_finish(&_qoz_sb_3048_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3056_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3056_21); qoz_strings_sb_append(&_qoz_sb_3056_21, QOZ_STR_LIT("!qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3056_21, record_name); qoz_strings_sb_append(&_qoz_sb_3056_21, QOZ_STR_LIT("(")); _qoz_bv_223 = qoz_strings_sb_finish(&_qoz_sb_3056_21);
    }
    qoz_emit_push(e, _qoz_bv_223); qoz_emit_emit_expr(e, lhs); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } int64_t p = qoz_emit_binary_prec(op); bool needs_paren_child = qoz_emit_is_logical_op(op); qoz_emit_emit_binary_child(e, lhs, p, needs_paren_child); qoz_string bop = qoz_emit_binary_c_op(op); qoz_string _qoz_bv_224;
    {
        qoz_Strbuf _qoz_sb_3060_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3060_13); qoz_strings_sb_append(&_qoz_sb_3060_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3060_13, bop); qoz_strings_sb_append(&_qoz_sb_3060_13, QOZ_STR_LIT(" ")); _qoz_bv_224 = qoz_strings_sb_finish(&_qoz_sb_3060_13);
    }
    qoz_emit_push(e, _qoz_bv_224); qoz_emit_emit_binary_child(e, rhs, p + 1, needs_paren_child); 
    return;
}
...
void qoz_emit_emit_fn_body_block(qoz_Emitter* e, qoz_Expr* body, qoz_TypeExpr* ret_hint) {
    ...
    0;  break; } default: { NULL;  break; } } 0; if ((defers.len) == 0) { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_push(e, e->current_return_restore); qoz_emit_push(e, QOZ_STR_LIT("return ")); qoz_emit_emit_value_with_hint(e, effective_tail, ret_hint); qoz_emit_push(e, QOZ_STR_LIT(";\n")); qoz_emit_close_statement_scope(e, saved); }  else { e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_225;
    {
        qoz_Strbuf _qoz_sb_3126_48 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3126_48); qoz_strings_sb_append_i64(&_qoz_sb_3126_48, e->closure_counter); _qoz_bv_225 = qoz_strings_sb_finish(&_qoz_sb_3126_48);
    }
    qoz_string tmp = qoz_strings_cat(QOZ_STR_LIT("_qoz_ret_"), _qoz_bv_225); qoz_string rt = qoz_emit_c_type_for(e, ret_hint); qoz_string _qoz_bv_226;
    {
        qoz_Strbuf _qoz_sb_3138_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3138_21); qoz_strings_sb_append(&_qoz_sb_3138_21, rt); qoz_strings_sb_append(&_qoz_sb_3138_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3138_21, tmp); qoz_strings_sb_append(&_qoz_sb_3138_21, QOZ_STR_LIT(" = ")); _qoz_bv_226 = qoz_strings_sb_finish(&_qoz_sb_3138_21);
    }
    qoz_emit_push(e, _qoz_bv_226); qoz_emit_emit_value_with_hint(e, effective_tail, ret_hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_emit_defers_reverse(e, defers); qoz_string _qoz_bv_227;
    {
        qoz_Strbuf _qoz_sb_3132_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3132_21); qoz_strings_sb_append(&_qoz_sb_3132_21, QOZ_STR_LIT("\n    return ")); qoz_strings_sb_append(&_qoz_sb_3132_21, tmp); qoz_strings_sb_append(&_qoz_sb_3132_21, QOZ_STR_LIT(";\n")); _qoz_bv_227 = qoz_strings_sb_finish(&_qoz_sb_3132_21);
    }
    qoz_emit_push(e, _qoz_bv_227); } 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
bool qoz_emit_is_unit_typeexpr(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_1 = (true);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; bool _qoz_bv_228;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_228 = qoz_strings_eq_raw(n, QOZ_STR_LIT("unit")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("void"));
    }
    _qoz_mv_1 = (_qoz_bv_228);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_fn(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_string ret_c = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_229;
    {
        qoz_Strbuf _qoz_sb_3263_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3263_13); qoz_strings_sb_append(&_qoz_sb_3263_13, ret_c); qoz_strings_sb_append(&_qoz_sb_3263_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3263_13, c_name); _qoz_bv_229 = qoz_strings_sb_finish(&_qoz_sb_3263_13);
    }
    qoz_emit_push(e, _qoz_bv_229); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void)")); }  else { qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_230;
    {
        qoz_Strbuf _qoz_sb_3273_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3273_21); qoz_strings_sb_append(&_qoz_sb_3273_21, pc); qoz_strings_sb_append(&_qoz_sb_3273_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3273_21, pn); _qoz_bv_230 = qoz_strings_sb_finish(&_qoz_sb_3273_21);
    }
    qoz_emit_push(e, _qoz_bv_230); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); } qoz_emit_push(e, QOZ_STR_LIT(" {\n    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();\n    ")); qoz_string saved_ret = e->current_return_restore; e->current_return_restore = QOZ_STR_LIT("qoz_gc_shadow_set_top(_qoz_shadow_guard); "); int64_t saved_match_counter = e->match_counter; e->match_counter = 0; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, p.name, p.ty); if (qoz_emit_c_type_is_pointer(qoz_emit_c_type_for(e, p.ty))) { qoz_string pn = p.name; qoz_string _qoz_bv_231;
    {
        qoz_Strbuf _qoz_sb_3292_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3292_21); qoz_strings_sb_append(&_qoz_sb_3292_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_3292_21, pn); qoz_strings_sb_append(&_qoz_sb_3292_21, QOZ_STR_LIT(");\n    ")); _qoz_bv_231 = qoz_strings_sb_finish(&_qoz_sb_3292_21);
    }
    qoz_emit_push(e, _qoz_bv_231); } } }e->current_ret_te = ret; bool is_b = qoz_emit_is_block(body); if (is_b) { qoz_emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string crr = e->current_return_restore; if (qoz_emit_is_unit_typeexpr(ret)) { qoz_emit_emit_expr(e, body); qoz_string _qoz_bv_232;
    {
        qoz_Strbuf _qoz_sb_3204_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3204_21); qoz_strings_sb_append(&_qoz_sb_3204_21, QOZ_STR_LIT(";\n    ")); qoz_strings_sb_append(&_qoz_sb_3204_21, crr); qoz_strings_sb_append(&_qoz_sb_3204_21, QOZ_STR_LIT("return;\n")); _qoz_bv_232 = qoz_strings_sb_finish(&_qoz_sb_3204_21);
    }
    qoz_emit_push(e, _qoz_bv_232); }  else { qoz_string _qoz_bv_233;
    {
        qoz_Strbuf _qoz_sb_3206_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3206_21); qoz_strings_sb_append(&_qoz_sb_3206_21, crr); qoz_strings_sb_append(&_qoz_sb_3206_21, QOZ_STR_LIT("return ")); _qoz_bv_233 = qoz_strings_sb_finish(&_qoz_sb_3206_21);
    }
    qoz_emit_push(e, _qoz_bv_233); qoz_emit_emit_value_with_hint(e, body, ret); qoz_emit_push(e, QOZ_STR_LIT(";\n")); } qoz_emit_close_statement_scope(e, saved); } e->current_return_restore = saved_ret; e->match_counter = saved_match_counter; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); qoz_emit_push(e, QOZ_STR_LIT("}\n\n")); 
    return;
}
...
qoz_Option__qoz_string* qoz_emit_value_field_dep(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_Option__qoz_string* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_Option__qoz_string* _qoz_bv_234;
    {
        if ((path.len) < 1) { return qoz_make_Option__qoz_string_None();} qoz_string n = path.data[(path.len) - 1]; if (!qoz_strings_eq_raw(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { return qoz_make_Option__qoz_string_None();} if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { return qoz_make_Option__qoz_string_None();} if ((args.len) > 0) { return qoz_make_Option__qoz_string_Some(qoz_emit_mangle_inst(e, n, args));} _qoz_bv_234 = qoz_make_Option__qoz_string_Some(n);
    }
    _qoz_mv_1 = (_qoz_bv_234);  break; } default: { _qoz_mv_1 = (qoz_make_Option__qoz_string_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_variant_ctor(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string vn = v.name; qoz_string _qoz_bv_241;
    {
        qoz_Strbuf _qoz_sb_3679_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3679_13); qoz_strings_sb_append(&_qoz_sb_3679_13, QOZ_STR_LIT("static qoz_")); qoz_strings_sb_append(&_qoz_sb_3679_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3679_13, QOZ_STR_LIT(" *qoz_make_")); qoz_strings_sb_append(&_qoz_sb_3679_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3679_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3679_13, vn); _qoz_bv_241 = qoz_strings_sb_finish(&_qoz_sb_3679_13);
    }
    qoz_emit_push(e, _qoz_bv_241); if (!qoz_emit_variant_has_positional(v)) { qoz_emit_push(e, QOZ_STR_LIT("(void) {\n")); }  else { qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; if (k > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, pt); qoz_string ks = qoz_emit_int_to_string(k); qoz_string _qoz_bv_242;
    {
        qoz_Strbuf _qoz_sb_3689_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3689_21); qoz_strings_sb_append(&_qoz_sb_3689_21, pc); qoz_strings_sb_append(&_qoz_sb_3689_21, QOZ_STR_LIT(" f")); qoz_strings_sb_append(&_qoz_sb_3689_21, ks); _qoz_bv_242 = qoz_strings_sb_finish(&_qoz_sb_3689_21);
    }
    qoz_emit_push(e, _qoz_bv_242); k = k + 1; } }qoz_emit_push(e, QOZ_STR_LIT(") {\n")); } qoz_string _qoz_bv_243;
    {
        qoz_Strbuf _qoz_sb_3684_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3684_13); qoz_strings_sb_append(&_qoz_sb_3684_13, QOZ_STR_LIT("    qoz_")); qoz_strings_sb_append(&_qoz_sb_3684_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3684_13, QOZ_STR_LIT(" *p = qoz_gc_alloc(sizeof(qoz_")); qoz_strings_sb_append(&_qoz_sb_3684_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3684_13, QOZ_STR_LIT("), &qoz_")); qoz_strings_sb_append(&_qoz_sb_3684_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3684_13, QOZ_STR_LIT("_desc);\n")); _qoz_bv_243 = qoz_strings_sb_finish(&_qoz_sb_3684_13);
    }
    qoz_emit_push(e, _qoz_bv_243); qoz_string _qoz_bv_244;
    {
        qoz_Strbuf _qoz_sb_3685_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3685_13); qoz_strings_sb_append(&_qoz_sb_3685_13, QOZ_STR_LIT("    p->tag = qoz_")); qoz_strings_sb_append(&_qoz_sb_3685_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3685_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3685_13, vn); qoz_strings_sb_append(&_qoz_sb_3685_13, QOZ_STR_LIT(";\n")); _qoz_bv_244 = qoz_strings_sb_finish(&_qoz_sb_3685_13);
    }
    qoz_emit_push(e, _qoz_bv_244); if (qoz_emit_variant_has_positional(v)) { int64_t j = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _ = __col.data[__i]; (void)_; qoz_string js = qoz_emit_int_to_string(j); qoz_string _qoz_bv_245;
    {
        qoz_Strbuf _qoz_sb_3690_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3690_21); qoz_strings_sb_append(&_qoz_sb_3690_21, QOZ_STR_LIT("    p->payload.")); qoz_strings_sb_append(&_qoz_sb_3690_21, vn); qoz_strings_sb_append(&_qoz_sb_3690_21, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_3690_21, js); qoz_strings_sb_append(&_qoz_sb_3690_21, QOZ_STR_LIT(" = f")); qoz_strings_sb_append(&_qoz_sb_3690_21, js); qoz_strings_sb_append(&_qoz_sb_3690_21, QOZ_STR_LIT(";\n")); _qoz_bv_245 = qoz_strings_sb_finish(&_qoz_sb_3690_21);
    }
    qoz_emit_push(e, _qoz_bv_245); j = j + 1; } }} qoz_emit_push(e, QOZ_STR_LIT("    return p;\n}\n\n")); 
    return;
}
...
void qoz_emit_emit_fn_proto(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_268;
    {
        qoz_Strbuf _qoz_sb_3958_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3958_13); qoz_strings_sb_append(&_qoz_sb_3958_13, rc); qoz_strings_sb_append(&_qoz_sb_3958_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3958_13, c_name); _qoz_bv_268 = qoz_strings_sb_finish(&_qoz_sb_3958_13);
    }
    qoz_emit_push(e, _qoz_bv_268); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void);\n")); return;} qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_269;
    {
        qoz_Strbuf _qoz_sb_3969_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3969_17); qoz_strings_sb_append(&_qoz_sb_3969_17, pc); qoz_strings_sb_append(&_qoz_sb_3969_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3969_17, pn); _qoz_bv_269 = qoz_strings_sb_finish(&_qoz_sb_3969_17);
    }
    qoz_emit_push(e, _qoz_bv_269); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
bool qoz_emit_hint_is_unsigned_int(qoz_TypeExpr* hint) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_1 = hint; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; bool _qoz_bv_261;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_261 = ((qoz_strings_eq_raw(n, QOZ_STR_LIT("u8")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u16"))) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u32"))) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u64"));
    }
    _qoz_mv_1 = (_qoz_bv_261);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_value_with_hint(qoz_Emitter* e, qoz_Expr* value, qoz_TypeExpr* hint) {
    ...
    qoz_Expr* _qoz_ms_1 = value; switch (_qoz_ms_1->tag) { case qoz_Expr_EString: { qoz_string raw = _qoz_ms_1->payload.EString.f1; {
        if (qoz_emit_hint_is_cstring(hint)) { qoz_emit_push(e, raw); }  else { qoz_string _qoz_bv_262;
    {
        qoz_Strbuf _qoz_sb_4072_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4072_21); qoz_strings_sb_append(&_qoz_sb_4072_21, QOZ_STR_LIT("QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4072_21, raw); qoz_strings_sb_append(&_qoz_sb_4072_21, QOZ_STR_LIT(")")); _qoz_bv_262 = qoz_strings_sb_finish(&_qoz_sb_4072_21);
    }
    qoz_emit_push(e, _qoz_bv_262); } return;
    }
    ...
    0;  break; } default: { qoz_emit_emit_value_with_hint(e, tail, hint);  break; } } 0; return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_263;
    {
        qoz_Strbuf _qoz_sb_4024_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4024_47); qoz_strings_sb_append_i64(&_qoz_sb_4024_47, counter); _qoz_bv_263 = qoz_strings_sb_finish(&_qoz_sb_4024_47);
    }
    qoz_string tmp_res = qoz_strings_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_263); qoz_string result_c = qoz_emit_c_type_for(e, hint); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_274;
    {
        qoz_Strbuf _qoz_sb_4027_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4027_17); qoz_strings_sb_append(&_qoz_sb_4027_17, result_c); qoz_strings_sb_append(&_qoz_sb_4027_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4027_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_4027_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_274 = qoz_strings_sb_finish(&_qoz_sb_4027_17);
    }
    qoz_emit_push(e, _qoz_bv_274); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_Expr* _qoz_ms_4 = tail; switch (_qoz_ms_4->tag) { case qoz_Expr_EWhile: { {
    ...
    {
        qoz_Strbuf _qoz_sb_4034_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4034_21); qoz_strings_sb_append(&_qoz_sb_4034_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4034_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4034_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_276 = qoz_strings_sb_finish(&_qoz_sb_4034_21);
    }
    qoz_emit_push(e, _qoz_bv_276); 
    }
    0;  break; } case qoz_Expr_EAssign: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_277;
    {
        qoz_Strbuf _qoz_sb_4034_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4034_21); qoz_strings_sb_append(&_qoz_sb_4034_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4034_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4034_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_277 = qoz_strings_sb_finish(&_qoz_sb_4034_21);
    }
    qoz_emit_push(e, _qoz_bv_277); 
    }
    0;  break; } default: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string _qoz_bv_278;
    {
        qoz_Strbuf _qoz_sb_4032_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4032_21); qoz_strings_sb_append(&_qoz_sb_4032_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4032_21, QOZ_STR_LIT(" = ")); _qoz_bv_278 = qoz_strings_sb_finish(&_qoz_sb_4032_21);
    }
    qoz_emit_push(e, _qoz_bv_278); qoz_emit_emit_value_with_hint(e, tail, hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_close_statement_scope(e, saved); 
    }
...
bool qoz_emit_emit_qualified_variant_with_hint(qoz_Emitter* e, qoz_Expr* base, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_1 = base; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_1->payload.EIdent.f1; bool _qoz_bv_279;
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return false;} qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { bool _qoz_bv_270;
    {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_271;
    {
        qoz_Strbuf _qoz_sb_4186_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4186_25); qoz_strings_sb_append(&_qoz_sb_4186_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4186_25, mangled); qoz_strings_sb_append(&_qoz_sb_4186_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4186_25, name); qoz_strings_sb_append(&_qoz_sb_4186_25, QOZ_STR_LIT("()")); _qoz_bv_271 = qoz_strings_sb_finish(&_qoz_sb_4186_25);
    }
    qoz_emit_push(e, _qoz_bv_271); }  else { qoz_string _qoz_bv_272;
    {
        qoz_Strbuf _qoz_sb_4188_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4188_25); qoz_strings_sb_append(&_qoz_sb_4188_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4188_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4188_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4188_25, name); qoz_strings_sb_append(&_qoz_sb_4188_25, QOZ_STR_LIT("()")); _qoz_bv_272 = qoz_strings_sb_finish(&_qoz_sb_4188_25);
    }
    qoz_emit_push(e, _qoz_bv_272); } _qoz_bv_270 = true;
    }
    _qoz_mv_2 = (_qoz_bv_270);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_2 = (false);  break; } } _qoz_bv_279 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_279);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_ident_with_hint(qoz_Emitter* e, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_1->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_273;
    {
        qoz_Strbuf _qoz_sb_4105_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4105_21); qoz_strings_sb_append(&_qoz_sb_4105_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4105_21, mangled); qoz_strings_sb_append(&_qoz_sb_4105_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4105_21, name); qoz_strings_sb_append(&_qoz_sb_4105_21, QOZ_STR_LIT("()")); _qoz_bv_273 = qoz_strings_sb_finish(&_qoz_sb_4105_21);
    }
    qoz_emit_push(e, _qoz_bv_273); return;} qoz_string _qoz_bv_284;
    {
        qoz_Strbuf _qoz_sb_4108_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4108_17); qoz_strings_sb_append(&_qoz_sb_4108_17, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4108_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4108_17, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4108_17, name); qoz_strings_sb_append(&_qoz_sb_4108_17, QOZ_STR_LIT("()")); _qoz_bv_284 = qoz_strings_sb_finish(&_qoz_sb_4108_17);
    }
    qoz_emit_push(e, _qoz_bv_284); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        qoz_TypeExpr* _qoz_ms_2 = hint; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_ps = _qoz_ms_2->payload.TEFn.f1; qoz_TypeExpr* fn_ret = _qoz_ms_2->payload.TEFn.f2; if (qoz_map_contains__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_string thunk = qoz_emit_register_fn_thunk(e, name, fn_ps, fn_ret); qoz_string clo_t = qoz_emit_c_type_for(e, hint); qoz_string _qoz_bv_285;
    {
        qoz_Strbuf _qoz_sb_4119_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4119_29); qoz_strings_sb_append(&_qoz_sb_4119_29, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4119_29, clo_t); qoz_strings_sb_append(&_qoz_sb_4119_29, QOZ_STR_LIT("){ .env = NULL, .fn = ")); qoz_strings_sb_append(&_qoz_sb_4119_29, thunk); qoz_strings_sb_append(&_qoz_sb_4119_29, QOZ_STR_LIT(" })")); _qoz_bv_285 = qoz_strings_sb_finish(&_qoz_sb_4119_29);
    }
    qoz_emit_push(e, _qoz_bv_285); return;} } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_push(e, name); 
    }
    0;  break; } } 0; 
    return;
}
...
void qoz_emit_emit_call_with_hint(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_TypeExpr* hint) {
    ...
    if ((type_args.len) > 0) { qoz_emit_emit_call(e, callee, type_args, args); return;} qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_strings_eq_raw(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_1->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_286;
    {
        qoz_Strbuf _qoz_sb_4200_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4200_25); qoz_strings_sb_append(&_qoz_sb_4200_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4200_25, mangled); qoz_strings_sb_append(&_qoz_sb_4200_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4200_25, variant_name); qoz_strings_sb_append(&_qoz_sb_4200_25, QOZ_STR_LIT("(")); _qoz_bv_286 = qoz_strings_sb_finish(&_qoz_sb_4200_25);
    }
    qoz_emit_push(e, _qoz_bv_286); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 
    }
...
qoz_Vec__qoz_TypeExpr qoz_emit_hint_args_for_enum(qoz_TypeExpr* hint, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_1 = hint; qoz_Vec__qoz_TypeExpr _qoz_mv_1 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_Vec__qoz_TypeExpr _qoz_bv_287;
    {
        if ((path.len) >= 1) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, enum_name)) { return args;} } _qoz_bv_287 = qoz_vec_make__qoz_TypeExpr();
    }
    _qoz_mv_1 = (_qoz_bv_287);  break; } default: { _qoz_mv_1 = (qoz_vec_make__qoz_TypeExpr());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_record_lit_with_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* effective = qoz_emit_pick_type_with_args(te, hint); qoz_gc_push_root(&effective); qoz_Vec__qoz_RecordFieldLit expanded = qoz_emit_expand_record_spread_fields(e, effective, fields); qoz_string ec = qoz_emit_c_type_for(e, effective); qoz_string _qoz_bv_288;
    {
        qoz_Strbuf _qoz_sb_4344_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4344_13); qoz_strings_sb_append(&_qoz_sb_4344_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4344_13, ec); qoz_strings_sb_append(&_qoz_sb_4344_13, QOZ_STR_LIT("){ ")); _qoz_bv_288 = qoz_strings_sb_finish(&_qoz_sb_4344_13);
    }
    qoz_emit_push(e, _qoz_bv_288); int64_t i = 0; { qoz_Vec__qoz_RecordFieldLit __col = expanded; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string fn = f.name; qoz_string _qoz_bv_289;
    {
        qoz_Strbuf _qoz_sb_4349_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4349_17); qoz_strings_sb_append(&_qoz_sb_4349_17, QOZ_STR_LIT(".")); qoz_strings_sb_append(&_qoz_sb_4349_17, fn); qoz_strings_sb_append(&_qoz_sb_4349_17, QOZ_STR_LIT(" = ")); _qoz_bv_289 = qoz_strings_sb_finish(&_qoz_sb_4349_17);
    }
    qoz_emit_push(e, _qoz_bv_289); qoz_TypeExpr* field_hint = qoz_emit_field_type_hint(e, effective, f.name); qoz_gc_push_root(&field_hint); qoz_emit_emit_value_with_hint(e, f.value, field_hint); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_field_type_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_280;
    {
        if ((path.len) < 1) { return te;} qoz_string name = qoz_emit_type_lookup_key(e, path); if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_decls, name)) { return te;} qoz_Option__qoz_Decl* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, name); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_2->payload.Some.f0; qoz_Decl* _qoz_ms_3 = decl; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_3->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_3->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_281;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; if (qoz_strings_eq_raw(sf.name, field_name)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, sf.ty, params, args);} return sf.ty;} } }_qoz_bv_281 = te;
    }
    _qoz_mv_3 = (_qoz_bv_281);  break; } default: { _qoz_mv_3 = (te);  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_2 = (te);  break; } } _qoz_bv_280 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_280);  break; } default: { _qoz_mv_1 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_pick_type_with_args(qoz_TypeExpr* te, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string te_path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr te_args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_282;
    {
        if ((te_args.len) > 0) { return te;} qoz_TypeExpr* _qoz_ms_2 = hint; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string h_path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr h_args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_283;
    {
        if ((h_args.len) == 0) { return te;} if ((((h_path.len) == 1) && ((te_path.len) == 1)) && qoz_strings_eq_raw(h_path.data[0], te_path.data[0])) { return hint;} _qoz_bv_283 = te;
    }
    _qoz_mv_2 = (_qoz_bv_283);  break; } default: { _qoz_mv_2 = (te);  break; } } _qoz_bv_282 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_282);  break; } default: { _qoz_mv_1 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_for_loop_one(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_1 = iter; switch (_qoz_ms_1->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* lo = _qoz_ms_1->payload.EBinary.f2; qoz_Expr* hi = _qoz_ms_1->payload.EBinary.f3; if (qoz_emit_is_range_op(op)) { qoz_string _qoz_bv_294;
    {
        qoz_Strbuf _qoz_sb_4404_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4404_21); qoz_strings_sb_append(&_qoz_sb_4404_21, QOZ_STR_LIT("for (int64_t ")); qoz_strings_sb_append(&_qoz_sb_4404_21, binding); qoz_strings_sb_append(&_qoz_sb_4404_21, QOZ_STR_LIT(" = ")); _qoz_bv_294 = qoz_strings_sb_finish(&_qoz_sb_4404_21);
    }
    qoz_emit_push(e, _qoz_bv_294); qoz_emit_emit_expr(e, lo); qoz_string cmp = qoz_emit_range_cmp_op(op); qoz_string _qoz_bv_295;
    {
        qoz_Strbuf _qoz_sb_4407_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4407_21); qoz_strings_sb_append(&_qoz_sb_4407_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4407_21, binding); qoz_strings_sb_append(&_qoz_sb_4407_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4407_21, cmp); qoz_strings_sb_append(&_qoz_sb_4407_21, QOZ_STR_LIT(" ")); _qoz_bv_295 = qoz_strings_sb_finish(&_qoz_sb_4407_21);
    }
    qoz_emit_push(e, _qoz_bv_295); qoz_emit_emit_expr(e, hi); qoz_string _qoz_bv_296;
    {
        qoz_Strbuf _qoz_sb_4419_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4419_21); qoz_strings_sb_append(&_qoz_sb_4419_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4419_21, binding); qoz_strings_sb_append(&_qoz_sb_4419_21, QOZ_STR_LIT("++) ")); _qoz_bv_296 = qoz_strings_sb_finish(&_qoz_sb_4419_21);
    }
    qoz_emit_push(e, _qoz_bv_296); qoz_emit_emit_branch_as_statement(e, body); return;} 0;  break; } default: { NULL;  break; } } 0; if (qoz_strings_eq_raw(binding2, QOZ_STR_LIT(""))) { qoz_emit_emit_vec_for(e, binding, iter, body); }  else { qoz_emit_emit_map_for(e, binding, binding2, iter, body); } 
    return;
}
...
void qoz_emit_emit_vec_for(qoz_Emitter* e, qoz_string binding, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* elem_te = qoz_emit_vec_element_typeexpr(e, iter); qoz_gc_push_root(&elem_te); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, binding, elem_te); qoz_string col_ct = qoz_emit_c_type_for(e, qoz_emit_infer_base_typeexpr(e, iter)); qoz_string elem_ct = qoz_emit_c_type_for(e, elem_te); qoz_string _qoz_bv_297;
    {
        qoz_Strbuf _qoz_sb_4439_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4439_13); qoz_strings_sb_append(&_qoz_sb_4439_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4439_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4439_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_297 = qoz_strings_sb_finish(&_qoz_sb_4439_13);
    }
    qoz_emit_push(e, _qoz_bv_297); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_298;
    {
        qoz_Strbuf _qoz_sb_4431_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4431_13); qoz_strings_sb_append(&_qoz_sb_4431_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.len; __i++) { ")); qoz_strings_sb_append(&_qoz_sb_4431_13, elem_ct); qoz_strings_sb_append(&_qoz_sb_4431_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4431_13, binding); qoz_strings_sb_append(&_qoz_sb_4431_13, QOZ_STR_LIT(" = __col.data[__i]; (void)")); qoz_strings_sb_append(&_qoz_sb_4431_13, binding); qoz_strings_sb_append(&_qoz_sb_4431_13, QOZ_STR_LIT("; ")); _qoz_bv_298 = qoz_strings_sb_finish(&_qoz_sb_4431_13);
    }
    qoz_emit_push(e, _qoz_bv_298); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_vec_element_typeexpr(qoz_Emitter* e, qoz_Expr* iter) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&iter);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_299;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_299 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_299);  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_1->payload.TEPtr.f1; _qoz_mv_1 = (inner);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(iter)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_map_for(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* iter_te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&iter_te); qoz_string col_ct = qoz_emit_c_type_for(e, iter_te); qoz_TypeExpr* key_te = qoz_emit_map_key_typeexpr(e, iter_te); qoz_gc_push_root(&key_te); qoz_TypeExpr* val_te = qoz_emit_map_val_typeexpr(e, iter_te); qoz_gc_push_root(&val_te); qoz_string key_ct = qoz_emit_c_type_for(e, key_te); qoz_string val_ct = qoz_emit_c_type_for(e, val_te); qoz_string _qoz_bv_290;
    {
        qoz_Strbuf _qoz_sb_4555_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4555_13); qoz_strings_sb_append(&_qoz_sb_4555_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4555_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4555_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_290 = qoz_strings_sb_finish(&_qoz_sb_4555_13);
    }
    qoz_emit_push(e, _qoz_bv_290); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_291;
    {
        qoz_Strbuf _qoz_sb_4557_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4557_13); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.cap; __i++) { if (!__col.slots[__i].occupied || __col.slots[__i].deleted) continue; ")); qoz_strings_sb_append(&_qoz_sb_4557_13, key_ct); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4557_13, binding); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT(" = __col.slots[__i].key; ")); qoz_strings_sb_append(&_qoz_sb_4557_13, val_ct); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4557_13, binding2); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT(" = __col.slots[__i].value; (void)")); qoz_strings_sb_append(&_qoz_sb_4557_13, binding); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4557_13, binding2); qoz_strings_sb_append(&_qoz_sb_4557_13, QOZ_STR_LIT("; ")); _qoz_bv_291 = qoz_strings_sb_finish(&_qoz_sb_4557_13);
    }
    qoz_emit_push(e, _qoz_bv_291); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_map_key_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_292;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[0];} _qoz_bv_292 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_292);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_map_val_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_293;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[1];} _qoz_bv_293 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_293);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    if (qoz_emit_any_arm_has_guard(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} if (qoz_emit_any_arm_is_literal(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); if (qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_304;
    {
        qoz_Strbuf _qoz_sb_4643_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4643_21); qoz_strings_sb_append(&_qoz_sb_4643_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4643_21, e->match_counter); _qoz_bv_304 = qoz_strings_sb_finish(&_qoz_sb_4643_21);
    }
    qoz_string scrut_tmp = _qoz_bv_304; qoz_string _qoz_bv_305;
    {
        qoz_Strbuf _qoz_sb_4644_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4644_21); qoz_strings_sb_append(&_qoz_sb_4644_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4644_21, e->match_counter); _qoz_bv_305 = qoz_strings_sb_finish(&_qoz_sb_4644_21);
    }
    qoz_string res_tmp = _qoz_bv_305; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_strings_eq_raw(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_306;
    {
        qoz_Strbuf _qoz_sb_4657_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4657_13); qoz_strings_sb_append(&_qoz_sb_4657_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4657_13, enum_name); qoz_strings_sb_append(&_qoz_sb_4657_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4657_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4657_13, QOZ_STR_LIT(" = ")); _qoz_bv_306 = qoz_strings_sb_finish(&_qoz_sb_4657_13);
    }
    qoz_emit_push(e, _qoz_bv_306); qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_307;
    {
        qoz_Strbuf _qoz_sb_4662_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4662_17); qoz_strings_sb_append(&_qoz_sb_4662_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4662_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4662_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4662_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4662_17, dv); qoz_strings_sb_append(&_qoz_sb_4662_17, QOZ_STR_LIT("; ")); _qoz_bv_307 = qoz_strings_sb_finish(&_qoz_sb_4662_17);
    }
    qoz_emit_push(e, _qoz_bv_307); } qoz_string _qoz_bv_308;
    {
        qoz_Strbuf _qoz_sb_4664_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4664_13); qoz_strings_sb_append(&_qoz_sb_4664_13, QOZ_STR_LIT("switch (")); qoz_strings_sb_append(&_qoz_sb_4664_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4664_13, QOZ_STR_LIT("->tag) { ")); _qoz_bv_308 = qoz_strings_sb_finish(&_qoz_sb_4664_13);
    }
    qoz_emit_push(e, _qoz_bv_308); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_match_arm_with_kind(e, enum_name, scrut_tmp, res_tmp, arm, is_void); } }qoz_emit_push(e, QOZ_STR_LIT("} ")); qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); bool is_enum_match = !qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT("")); qoz_string enum_name = QOZ_STR_LIT(""); if (is_enum_match) { enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); } qoz_string scrut_ctype = qoz_emit_infer_expr_ctype(e, scrut); qoz_TypeExpr* scrut_te = qoz_emit_infer_value_te(e, scrut); qoz_gc_push_root(&scrut_te); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_309;
    {
        qoz_Strbuf _qoz_sb_4685_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4685_21); qoz_strings_sb_append(&_qoz_sb_4685_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4685_21, e->match_counter); _qoz_bv_309 = qoz_strings_sb_finish(&_qoz_sb_4685_21);
    }
    qoz_string scrut_tmp = _qoz_bv_309; qoz_string _qoz_bv_300;
    {
        qoz_Strbuf _qoz_sb_4686_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4686_21); qoz_strings_sb_append(&_qoz_sb_4686_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4686_21, e->match_counter); _qoz_bv_300 = qoz_strings_sb_finish(&_qoz_sb_4686_21);
    }
    qoz_string res_tmp = _qoz_bv_300; qoz_string _qoz_bv_301;
    {
        qoz_Strbuf _qoz_sb_4687_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4687_21); qoz_strings_sb_append(&_qoz_sb_4687_21, QOZ_STR_LIT("_qoz_mm_")); qoz_strings_sb_append_i64(&_qoz_sb_4687_21, e->match_counter); _qoz_bv_301 = qoz_strings_sb_finish(&_qoz_sb_4687_21);
    }
    qoz_string mflag = _qoz_bv_301; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_strings_eq_raw(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); if (is_enum_match) { qoz_string _qoz_bv_302;
    {
        qoz_Strbuf _qoz_sb_4692_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4692_17); qoz_strings_sb_append(&_qoz_sb_4692_17, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4692_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4692_17, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4692_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4692_17, QOZ_STR_LIT(" = ")); _qoz_bv_302 = qoz_strings_sb_finish(&_qoz_sb_4692_17);
    }
    qoz_emit_push(e, _qoz_bv_302); }  else { qoz_string _qoz_bv_303;
    {
        qoz_Strbuf _qoz_sb_4694_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4694_17); qoz_strings_sb_append(&_qoz_sb_4694_17, scrut_ctype); qoz_strings_sb_append(&_qoz_sb_4694_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4694_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4694_17, QOZ_STR_LIT(" = ")); _qoz_bv_303 = qoz_strings_sb_finish(&_qoz_sb_4694_17);
    }
    qoz_emit_push(e, _qoz_bv_303); } qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_314;
    {
        qoz_Strbuf _qoz_sb_4690_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4690_17); qoz_strings_sb_append(&_qoz_sb_4690_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4690_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4690_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4690_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4690_17, dv); qoz_strings_sb_append(&_qoz_sb_4690_17, QOZ_STR_LIT("; ")); _qoz_bv_314 = qoz_strings_sb_finish(&_qoz_sb_4690_17);
    }
    qoz_emit_push(e, _qoz_bv_314); } qoz_string _qoz_bv_315;
    {
        qoz_Strbuf _qoz_sb_4602_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4602_13); qoz_strings_sb_append(&_qoz_sb_4602_13, QOZ_STR_LIT("bool ")); qoz_strings_sb_append(&_qoz_sb_4602_13, mflag); qoz_strings_sb_append(&_qoz_sb_4602_13, QOZ_STR_LIT(" = false; ")); _qoz_bv_315 = qoz_strings_sb_finish(&_qoz_sb_4602_13);
    }
    qoz_emit_push(e, _qoz_bv_315); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_arm_in_chain_with_te(e, enum_name, scrut_tmp, scrut_te, res_tmp, mflag, arm, is_void); } }qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    ...
    0;  break; } case qoz_Option__qoz_string_None: { {
        if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("default: { ")); }  else { qoz_string _qoz_bv_326;
    {
        qoz_Strbuf _qoz_sb_4734_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4734_25); qoz_strings_sb_append(&_qoz_sb_4734_25, QOZ_STR_LIT("default: { int64_t ")); qoz_strings_sb_append(&_qoz_sb_4734_25, name); qoz_strings_sb_append(&_qoz_sb_4734_25, QOZ_STR_LIT(" = 0; (void)")); qoz_strings_sb_append(&_qoz_sb_4734_25, name); qoz_strings_sb_append(&_qoz_sb_4734_25, QOZ_STR_LIT("; ")); _qoz_bv_326 = qoz_strings_sb_finish(&_qoz_sb_4734_25);
    }
    qoz_emit_push(e, _qoz_bv_326); } if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_1->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_327;
    {
        qoz_Strbuf _qoz_sb_4852_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4852_21); qoz_strings_sb_append(&_qoz_sb_4852_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4852_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4852_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4852_21, vname); qoz_strings_sb_append(&_qoz_sb_4852_21, QOZ_STR_LIT(": { ")); _qoz_bv_327 = qoz_strings_sb_finish(&_qoz_sb_4852_21);
    }
    qoz_emit_push(e, _qoz_bv_327); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_3 = sp; switch (_qoz_ms_3->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_3->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_328;
    {
        qoz_Strbuf _qoz_sb_4859_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4859_29); qoz_strings_sb_append(&_qoz_sb_4859_29, pc); qoz_strings_sb_append(&_qoz_sb_4859_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4859_29, bname); qoz_strings_sb_append(&_qoz_sb_4859_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4859_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4859_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4859_29, vname); qoz_strings_sb_append(&_qoz_sb_4859_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4859_29, is); qoz_strings_sb_append(&_qoz_sb_4859_29, QOZ_STR_LIT("; ")); _qoz_bv_328 = qoz_strings_sb_finish(&_qoz_sb_4859_29);
    }
    qoz_emit_push(e, _qoz_bv_328); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string qoz_emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_string _qoz_bv_329;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, bare_enum)) { return qoz_emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_329 = bare_enum;
    }
    _qoz_mv_1 = (_qoz_bv_329);  break; } default: { _qoz_mv_1 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_1->payload.TyInt.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TENamed(sp, qoz_ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_1->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_336;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_336 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_1 = (_qoz_bv_336);  break; } case qoz_Ty_TyBool: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEPtr(sp, qoz_ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyAdt.f1; _qoz_mv_1 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; _qoz_mv_1 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_1->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_337;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, qoz_ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_337 = qoz_make_TypeExpr_TEFn(sp, pte, qoz_ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_1 = (_qoz_bv_337);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_1->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_338;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, qoz_ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_338 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_1 = (_qoz_bv_338);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_1->payload.TyVar.f1; _qoz_mv_1 = (qoz_ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_ty_ty_show(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo i = _qoz_ms_1->payload.TyInt.f0; qoz_string _qoz_bv_339;
    {
        qoz_string prefix = ((i.is_signed) ? QOZ_STR_LIT("i") : QOZ_STR_LIT("u")); qoz_string w = ((i.width == 8) ? QOZ_STR_LIT("8") : ((i.width == 16) ? QOZ_STR_LIT("16") : ((i.width == 32) ? QOZ_STR_LIT("32") : QOZ_STR_LIT("64")))); _qoz_bv_339 = qoz_strings_cat(prefix, w);
    }
    _qoz_mv_1 = (_qoz_bv_339);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo f = _qoz_ms_1->payload.TyFloat.f0; _qoz_mv_1 = (((f.width == 32) ? QOZ_STR_LIT("f32") : QOZ_STR_LIT("f64")));  break; } case qoz_Ty_TyBool: { _qoz_mv_1 = (QOZ_STR_LIT("bool"));  break; } case qoz_Ty_TyChar: { _qoz_mv_1 = (QOZ_STR_LIT("char"));  break; } case qoz_Ty_TyString: { _qoz_mv_1 = (QOZ_STR_LIT("string"));  break; } case qoz_Ty_TyCstring: { _qoz_mv_1 = (QOZ_STR_LIT("cstring"));  break; } case qoz_Ty_TyUnit: { _qoz_mv_1 = (QOZ_STR_LIT("unit"));  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (QOZ_STR_LIT("nil"));  break; } case qoz_Ty_TyError: { _qoz_mv_1 = (QOZ_STR_LIT("<error>"));  break; } case qoz_Ty_TyVar: { qoz_string n = _qoz_ms_1->payload.TyVar.f1; _qoz_mv_1 = (n);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_strings_cat(QOZ_STR_LIT("*"), qoz_ty_ty_show(inner)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyAdt.f1; qoz_string _qoz_bv_330;
    {
    ...
    _qoz_mv_1 = (_qoz_bv_330);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; qoz_string _qoz_bv_331;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_strings_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_331 = qoz_strings_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_1 = (_qoz_bv_331);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty params = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_1->payload.TyFn.f1; qoz_string _qoz_bv_332;
    {
        qoz_string out = QOZ_STR_LIT("fn("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(p)); i = i + 1; } }out = qoz_strings_cat(out, QOZ_STR_LIT(") -> ")); _qoz_bv_332 = qoz_strings_cat(out, qoz_ty_ty_show(ret));
    }
    _qoz_mv_1 = (_qoz_bv_332);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_1->payload.TyTuple.f0; qoz_string _qoz_bv_333;
    {
        qoz_string out = QOZ_STR_LIT("("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* e = __col.data[__i]; (void)e; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(e)); i = i + 1; } }_qoz_bv_333 = qoz_strings_cat(out, QOZ_STR_LIT(")"));
    }
    _qoz_mv_1 = (_qoz_bv_333);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_ty_arg_passes_to_param(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_1 = arg; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyError: { _qoz_mv_1 = (true);  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (qoz_ty_arg_is_nil_accepted_by(param));  break; } case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_1->payload.TyInt.f0; bool _qoz_bv_344;
    {
        if (ai.untyped && qoz_ty_untyped_int_fits(param)) { return true;} qoz_Ty* _qoz_ms_2 = param; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_2->payload.TyInt.f0; _qoz_mv_2 = (qoz_ty_int_widens_to(pi, ai));  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_bv_344 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_344);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_1->payload.TyFloat.f0; bool _qoz_bv_345;
    {
        if (af.untyped && qoz_ty_untyped_float_fits(param)) { return true;} qoz_Ty* _qoz_ms_3 = param; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_3->payload.TyFloat.f0; _qoz_mv_3 = (pf.width >= af.width);  break; } default: { _qoz_mv_3 = (false);  break; } } _qoz_bv_345 = _qoz_mv_3;
    }
    _qoz_mv_1 = (_qoz_bv_345);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_ty_same_constructor_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_1 = param; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_1->payload.TyAdt.f1; qoz_Ty* _qoz_ms_2 = arg; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_2->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_2->payload.TyAdt.f1; bool _qoz_bv_346;
    {
